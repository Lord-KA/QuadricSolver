\hypertarget{md_build__deps_googletest_src_googletest__r_e_a_d_m_e_autotoc_md1223}{}\doxysubsubsection{Setup}\label{md_build__deps_googletest_src_googletest__r_e_a_d_m_e_autotoc_md1223}
To build Google Test and your tests that use it, you need to tell your build system where to find its headers and source files. The exact way to do it depends on which build system you use, and is usually straightforward.\hypertarget{md_build__deps_googletest_src_googletest__r_e_a_d_m_e_autotoc_md1224}{}\doxysubsubsection{Build}\label{md_build__deps_googletest_src_googletest__r_e_a_d_m_e_autotoc_md1224}
...
./sample1_unittest
\end{DoxyVerb}
 If you see errors, try to tweak the contents of {\ttfamily make/\+Makefile} to make them go away. There are instructions in {\ttfamily make/\+Makefile} on how to do it.\hypertarget{md_build__deps_googletest_src_googletest__r_e_a_d_m_e_autotoc_md1225}{}\doxysubsection{Using CMake}\label{md_build__deps_googletest_src_googletest__r_e_a_d_m_e_autotoc_md1225}
...
On Mac OS X with Xcode installed, a {\ttfamily .xcodeproj} file will be generated.\hypertarget{md_build__deps_googletest_src_googletest__r_e_a_d_m_e_autotoc_md1226}{}\doxysubsection{Legacy Build Scripts}\label{md_build__deps_googletest_src_googletest__r_e_a_d_m_e_autotoc_md1226}
...
\end{DoxyItemize}\hypertarget{md_build__deps_googletest_src_googletest__r_e_a_d_m_e_autotoc_md1227}{}\doxysubsection{Tweaking Google Test}\label{md_build__deps_googletest_src_googletest__r_e_a_d_m_e_autotoc_md1227}
...
We list the most frequently used macros below. For a complete list, see file \href{include/gtest/internal/gtest-port.h}{\texttt{ include/gtest/internal/gtest-\/port.\+h}}.\hypertarget{md_build__deps_googletest_src_googletest__r_e_a_d_m_e_autotoc_md1228}{}\doxysubsection{Choosing a TR1 Tuple Library}\label{md_build__deps_googletest_src_googletest__r_e_a_d_m_e_autotoc_md1228}
...
\end{DoxyVerb}
 and all features using tuple will be disabled.\hypertarget{md_build__deps_googletest_src_googletest__r_e_a_d_m_e_autotoc_md1229}{}\doxysubsection{Multi-\/threaded Tests}\label{md_build__deps_googletest_src_googletest__r_e_a_d_m_e_autotoc_md1229}
...
Note\+: while the above steps aren\textquotesingle{}t technically necessary today when using some compilers (e.\+g. GCC), they may become necessary in the future, if we decide to improve the speed of loading the library (see \href{http://gcc.gnu.org/wiki/Visibility}{\texttt{ http\+://gcc.\+gnu.\+org/wiki/\+Visibility}} for details). Therefore you are recommended to always add the above flags when using Google Test as a shared library. Otherwise a future release of Google Test may break your build script.\hypertarget{md_build__deps_googletest_src_googletest__r_e_a_d_m_e_autotoc_md1231}{}\doxysubsection{Avoiding Macro Name Clashes}\label{md_build__deps_googletest_src_googletest__r_e_a_d_m_e_autotoc_md1231}
...
\end{DoxyVerb}
 in order to define a test.\hypertarget{md_build__deps_googletest_src_googletest__r_e_a_d_m_e_autotoc_md1232}{}\doxysection{Developing Google Test}\label{md_build__deps_googletest_src_googletest__r_e_a_d_m_e_autotoc_md1232}
This section discusses how to make your own changes to Google Test.\hypertarget{md_build__deps_googletest_src_googletest__r_e_a_d_m_e_autotoc_md1233}{}\doxysubsection{Testing Google Test Itself}\label{md_build__deps_googletest_src_googletest__r_e_a_d_m_e_autotoc_md1233}
...
Normally you don\textquotesingle{}t need to worry about regenerating the source files, unless you need to modify them. In that case, you should modify the corresponding .pump files instead and run the pump.\+py Python script to regenerate them. You can find pump.\+py in the \href{scripts/}{\texttt{ scripts/}} directory. Read the \mbox{\hyperlink{md_build__deps_googletest_src_googletest_docs__pump_manual}{Pump manual}} for how to use it. 