Now that you have read \mbox{\hyperlink{md_build__deps_googletest_src_googletest_docs__primer}{Primer}} and learned how to write tests using Google Test, it\textquotesingle{}s time to learn some new tricks. This document will show you more assertions as well as how to construct complex failure messages, propagate fatal failures, reuse and speed up your test fixtures, and use various flags with your tests.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md654}{}\doxysection{More Assertions}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md654}
This section covers some less frequently used, but still significant, assertions.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md655}{}\doxysubsection{Explicit Success and Failure}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md655}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md656}{}\doxysubsection{Exception Assertions}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md656}
...
{\itshape Availability}\+: Linux, Windows, Mac; since version 1.\+1.\+0.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md657}{}\doxysubsection{Predicate Assertions for Better Error Messages}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md657}
...
Google Test gives you three different options to solve this problem\+:\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md658}{}\doxysubsubsection{Using an Existing Boolean Function}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md658}
...
{\itshape Availability}\+: Linux, Windows, Mac\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md659}{}\doxysubsubsection{Using a Function That Returns an Assertion\+Result}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md659}
...
{\itshape Availability}\+: Linux, Windows, Mac; since version 1.\+4.\+1.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md660}{}\doxysubsubsection{Using a Predicate-\/\+Formatter}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md660}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md661}{}\doxysubsection{Floating-\/\+Point Comparison}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md661}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md663}{}\doxysubsubsection{Floating-\/\+Point Predicate-\/\+Format Functions}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md663}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md664}{}\doxysubsection{Windows HRESULT assertions}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md664}
...
{\itshape Availability}\+: Windows.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md665}{}\doxysubsection{Type Assertions}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md665}
...
{\itshape Availability\+:} Linux, Windows, Mac; since version 1.\+3.\+0.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md666}{}\doxysubsection{Assertion Placement}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md666}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md668}{}\doxysection{Death Tests}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md668}
...
If you want to test {\ttfamily EXPECT\+\_\+$\ast$()/\+ASSERT\+\_\+$\ast$()} failures in your test code, see \href{\#catching-failures}{\texttt{ Catching Failures}}.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md669}{}\doxysubsection{How to Write a Death Test}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md669}
...
{\itshape Availability\+:} Linux, Windows (requires MSVC 8.\+0 or above), Cygwin, and Mac (the latter three are supported since v1.\+3.\+0). {\ttfamily (ASSERT$\vert$\+EXPECT)\+\_\+\+DEATH\+\_\+\+IF\+\_\+\+SUPPORTED} are new in v1.\+4.\+0.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md670}{}\doxysubsection{Regular Expression Syntax}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md670}
...
If the death test statement runs to completion without dying, the child process will nonetheless terminate, and the assertion fails.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md672}{}\doxysubsection{Death Tests And Threads}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md672}
...
It\textquotesingle{}s perfectly fine to create threads inside a death test statement; they are executed in a separate process and cannot affect the parent.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md673}{}\doxysubsection{Death Test Styles}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md673}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md674}{}\doxysubsection{Caveats}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md674}
...
Despite the improved thread safety afforded by the \char`\"{}threadsafe\char`\"{} style of death test, thread problems such as deadlock are still possible in the presence of handlers registered with {\ttfamily pthread\+\_\+atfork(3)}.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md675}{}\doxysection{Using Assertions in Sub-\/routines}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md675}
\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md676}{}\doxysubsection{Adding Traces to Assertions}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md676}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md677}{}\doxysubsection{Propagating Fatal Failures}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md677}
...
{\itshape Availability\+:} Linux, Windows, Mac. Assertions from multiple threads are currently not supported.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md679}{}\doxysubsubsection{Checking for Failures in the Current Test}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md679}
...
{\itshape Availability\+:} Linux, Windows, Mac. {\ttfamily Has\+Nonfatal\+Failure()} and {\ttfamily Has\+Failure()} are available since version 1.\+4.\+0.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md680}{}\doxysection{Logging Additional Information}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md680}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md681}{}\doxysection{Sharing Resources Between Tests in the Same Test Case}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md681}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md682}{}\doxysection{Global Set-\/\+Up and Tear-\/\+Down}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md682}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md683}{}\doxysection{Value Parameterized Tests}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md683}
...
\end{DoxyItemize}\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md684}{}\doxysubsection{How to Write Value-\/\+Parameterized Tests}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md684}
...
{\itshape Availability}\+: Linux, Windows (requires MSVC 8.\+0 or above), Mac; since version 1.\+2.\+0.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md685}{}\doxysubsection{Creating Value-\/\+Parameterized Abstract Tests}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md685}
...
Once they are defined, you can instantiate them by including {\ttfamily foo\+\_\+param\+\_\+test.\+h}, invoking {\ttfamily INSTANTIATE\+\_\+\+TEST\+\_\+\+CASE\+\_\+\+P()}, and linking with {\ttfamily foo\+\_\+param\+\_\+test.\+cc}. You can instantiate the same abstract test case multiple times, possibly in different source files.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md686}{}\doxysection{Typed Tests}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md686}
...
{\itshape Availability\+:} Linux, Windows (requires MSVC 8.\+0 or above), Mac; since version 1.\+1.\+0.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md687}{}\doxysection{Type-\/\+Parameterized Tests}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md687}
...
{\itshape Availability\+:} Linux, Windows (requires MSVC 8.\+0 or above), Mac; since version 1.\+1.\+0.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md688}{}\doxysection{Testing Private Code}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md688}
...
\end{DoxyItemize}\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md689}{}\doxysubsection{Static Functions}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md689}
...
However, a better approach is to move the private code into the {\ttfamily foo\+::internal} namespace, where {\ttfamily foo} is the namespace your project normally uses, and put the private declarations in a {\ttfamily $\ast$-\/internal.h} file. Your production {\ttfamily .cc} files and your tests are allowed to include this internal header, but your clients are not. This way, you can fully test your internal implementation without leaking it to your clients.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md690}{}\doxysubsection{Private Class Members}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md690}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md691}{}\doxysection{Catching Failures}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md691}
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md692}{}\doxysection{Getting the Current Test\textquotesingle{}s Name}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md692}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md693}{}\doxysection{Extending Google Test by Handling Test Events}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md693}
...
{\itshape Availability\+:} Linux, Windows, Mac; since v1.\+4.\+0.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md694}{}\doxysubsection{Defining Event Listeners}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md694}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md695}{}\doxysubsection{Using Event Listeners}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md695}
...
You may append more than one listener to the list. When an {\ttfamily On$\ast$\+Start()} or {\ttfamily On\+Test\+Part\+Result()} event is fired, the listeners will receive it in the order they appear in the list (since new listeners are added to the end of the list, the default text printer and the default XML generator will receive the event first). An {\ttfamily On$\ast$\+End()} event will be received by the listeners in the {\itshape reverse} order. This allows output by listeners added later to be framed by output from listeners added earlier.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md696}{}\doxysubsection{Generating Failures in Listeners}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md696}
...
We have a sample of failure-\/raising listener \href{../samples/sample10_unittest.cc}{\texttt{ here}}.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md697}{}\doxysection{Running Test Programs\+: Advanced Options}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md697}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md698}{}\doxysubsection{Selecting Tests}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md698}
This section shows various options for choosing which tests to run.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md699}{}\doxysubsubsection{Listing Test Names}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md699}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md700}{}\doxysubsubsection{Running a Subset of the Tests}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md700}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md701}{}\doxysubsubsection{Temporarily Disabling Tests}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md701}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md702}{}\doxysubsubsection{Temporarily Enabling Disabled Tests}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md702}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md703}{}\doxysubsection{Repeating the Tests}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md703}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md704}{}\doxysubsection{Shuffling the Tests}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md704}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md705}{}\doxysubsection{Controlling Test Output}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md705}
{\itshape  This section teaches how to tweak the way test results are reported.}

{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md706}{}\doxysubsubsection{Colored Terminal Output}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md706}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md707}{}\doxysubsubsection{Suppressing the Elapsed Time}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md707}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md708}{}\doxysubsubsection{Generating an XML Report}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md708}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md709}{}\doxysubsection{Controlling How Failures Are Reported}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md709}
{\itshape  }\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md710}{}\doxysubsubsection{Turning Assertion Failures into Break-\/\+Points}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md710}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md711}{}\doxysubsubsection{Disabling Catching Test-\/\+Thrown Exceptions}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md711}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md712}{}\doxysubsubsection{Letting Another Testing Framework Drive}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md712}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md713}{}\doxysubsection{Distributing Test Functions to Multiple Machines}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md713}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md714}{}\doxysection{Fusing Google Test Source Files}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md714}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md715}{}\doxysection{Where to Go from Here}\label{md_build__deps_googletest_src_googletest_docs__advanced_guide_autotoc_md715}
{\itshape  Congratulations! You\textquotesingle{}ve now learned more advanced Google Test tools and are ready to tackle more complex testing tasks. If you want to dive even deeper, you can read the \mbox{\hyperlink{md_build__deps_googletest_src_googletest_docs__f_a_q}{Frequently-\/\+Asked Questions}}. }