...
\end{DoxyEnumerate}\hypertarget{md_build__deps_googletest_src_googlemock_docs__for_dummies_autotoc_md142}{}\doxysection{Why Google Mock?}\label{md_build__deps_googletest_src_googlemock_docs__for_dummies_autotoc_md142}
...
\end{DoxyItemize}\hypertarget{md_build__deps_googletest_src_googlemock_docs__for_dummies_autotoc_md143}{}\doxysection{Getting Started}\label{md_build__deps_googletest_src_googlemock_docs__for_dummies_autotoc_md143}
Using Google \mbox{\hyperlink{class_mock}{Mock}} is easy! Inside your C++ source file, just {\ttfamily \#include} {\ttfamily \char`\"{}gtest/gtest.\+h\char`\"{}} and {\ttfamily \char`\"{}gmock/gmock.\+h\char`\"{}}, and you are ready to go.\hypertarget{md_build__deps_googletest_src_googlemock_docs__for_dummies_autotoc_md144}{}\doxysection{A Case for Mock Turtles}\label{md_build__deps_googletest_src_googlemock_docs__for_dummies_autotoc_md144}
...
Admittedly, this test is contrived and doesn\textquotesingle{}t do much. You can easily achieve the same effect without using Google \mbox{\hyperlink{class_mock}{Mock}}. However, as we shall reveal soon, Google \mbox{\hyperlink{class_mock}{Mock}} allows you to do {\itshape much more} with the mocks.\hypertarget{md_build__deps_googletest_src_googlemock_docs__for_dummies_autotoc_md149}{}\doxysubsection{Using Google Mock with Any Testing Framework}\label{md_build__deps_googletest_src_googlemock_docs__for_dummies_autotoc_md149}
...
If this turns out to be too much work, we suggest that you stick with Google Test, which works with Google \mbox{\hyperlink{class_mock}{Mock}} seamlessly (in fact, it is technically part of Google \mbox{\hyperlink{class_mock}{Mock}}.). If there is a reason that you cannot use Google Test, please let us know.\hypertarget{md_build__deps_googletest_src_googlemock_docs__for_dummies_autotoc_md150}{}\doxysection{Setting Expectations}\label{md_build__deps_googletest_src_googlemock_docs__for_dummies_autotoc_md150}
The key to using a mock object successfully is to set the {\itshape right expectations} on it. If you set the expectations too strict, your test will fail as the result of unrelated changes. If you set them too loose, bugs can slip through. You want to do it just right such that your test can catch exactly the kind of bugs you intend it to catch. Google \mbox{\hyperlink{class_mock}{Mock}} provides the necessary means for you to do it \char`\"{}just right.\char`\"{}\hypertarget{md_build__deps_googletest_src_googlemock_docs__for_dummies_autotoc_md151}{}\doxysubsection{General Syntax}\label{md_build__deps_googletest_src_googlemock_docs__for_dummies_autotoc_md151}
...
A list of built-\/in matchers can be found in the \mbox{\hyperlink{md_build__deps_googletest_src_googlemock_docs__cheat_sheet}{Cheat\+Sheet}}. For example, here\textquotesingle{}s the {\ttfamily Ge} (greater than or equal) matcher\+:
...
This checks that the turtle will be told to go forward by at least 100 units.\hypertarget{md_build__deps_googletest_src_googlemock_docs__for_dummies_autotoc_md153}{}\doxysubsection{Cardinalities\+: How Many Times Will It Be Called?}\label{md_build__deps_googletest_src_googlemock_docs__for_dummies_autotoc_md153}
...
We\textquotesingle{}ve seen {\ttfamily At\+Least(n)} as an example of fuzzy cardinalities earlier. For the list of built-\/in cardinalities you can use, see the \mbox{\hyperlink{md_build__deps_googletest_src_googlemock_docs__cheat_sheet}{Cheat\+Sheet}}.
...
{\bfseries{Quick quiz\+:}} what do you think will happen if a function is expected to be called twice but actually called four times?\hypertarget{md_build__deps_googletest_src_googlemock_docs__for_dummies_autotoc_md154}{}\doxysubsection{Actions\+: What Should It Do?}\label{md_build__deps_googletest_src_googlemock_docs__for_dummies_autotoc_md154}
...
Instead of returning 100, 101, 102, ..., consecutively, this mock function will always return 100 as {\ttfamily n++} is only evaluated once. Similarly, {\ttfamily Return(new Foo)} will create a new {\ttfamily Foo} object when the {\ttfamily EXPECT\+\_\+\+CALL()} is executed, and will return the same pointer every time. If you want the side effect to happen every time, you need to define a custom action, which we\textquotesingle{}ll teach in the \mbox{\hyperlink{md_build__deps_googletest_src_googlemock_docs__cook_book}{Cook\+Book}}.
...
(What if you care about the relative order of some of the calls, but not all of them? Can you specify an arbitrary partial order? The answer is ... yes! If you are impatient, the details can be found in the Cook\+Book.)\hypertarget{md_build__deps_googletest_src_googlemock_docs__for_dummies_autotoc_md157}{}\doxysubsection{All Expectations Are Sticky (\+Unless Said Otherwise)}\label{md_build__deps_googletest_src_googlemock_docs__for_dummies_autotoc_md157}
...
Then, if you feel like increasing your mock quotient, you should move on to the \mbox{\hyperlink{md_build__deps_googletest_src_googlemock_docs__cook_book}{Cook\+Book}}. You can learn many advanced features of Google \mbox{\hyperlink{class_mock}{Mock}} there -- and advance your level of enjoyment and testing bliss. 