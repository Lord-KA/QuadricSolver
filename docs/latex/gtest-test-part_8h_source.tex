...
\DoxyCodeLine{47 \textcolor{keyword}{class }GTEST\_API\_ \mbox{\hyperlink{classtesting_1_1_test_part_result}{TestPartResult}} \{}
...
\DoxyCodeLine{60   \mbox{\hyperlink{classtesting_1_1_test_part_result}{TestPartResult}}(Type a\_type,}
...
\DoxyCodeLine{120 std::ostream\& operator<<(std::ostream\& os, \textcolor{keyword}{const} \mbox{\hyperlink{classtesting_1_1_test_part_result}{TestPartResult}}\& result);}
\DoxyCodeLine{121 }
...
\DoxyCodeLine{126 \textcolor{keyword}{class }GTEST\_API\_ \mbox{\hyperlink{classtesting_1_1_test_part_result_array}{TestPartResultArray}} \{}
\DoxyCodeLine{127  \textcolor{keyword}{public}:}
\DoxyCodeLine{128   \mbox{\hyperlink{classtesting_1_1_test_part_result_array}{TestPartResultArray}}() \{\}}
\DoxyCodeLine{129 }
\DoxyCodeLine{130   \textcolor{comment}{// Appends the given TestPartResult to the array.}}
\DoxyCodeLine{131   \textcolor{keywordtype}{void} Append(\textcolor{keyword}{const} \mbox{\hyperlink{classtesting_1_1_test_part_result}{TestPartResult}}\& result);}
\DoxyCodeLine{132 }
\DoxyCodeLine{133   \textcolor{comment}{// Returns the TestPartResult at the given index (0-\/based).}}
\DoxyCodeLine{134   \textcolor{keyword}{const} \mbox{\hyperlink{classtesting_1_1_test_part_result}{TestPartResult}}\& GetTestPartResult(\textcolor{keywordtype}{int} index) \textcolor{keyword}{const};}
\DoxyCodeLine{135 }
...
\DoxyCodeLine{141 }
\DoxyCodeLine{142   GTEST\_DISALLOW\_COPY\_AND\_ASSIGN\_(\mbox{\hyperlink{classtesting_1_1_test_part_result_array}{TestPartResultArray}});}
\DoxyCodeLine{143 \};}
\DoxyCodeLine{144 }
\DoxyCodeLine{145 \textcolor{comment}{// This interface knows how to report a test part result.}}
\DoxyCodeLine{146 \textcolor{keyword}{class }\mbox{\hyperlink{classtesting_1_1_test_part_result_reporter_interface}{TestPartResultReporterInterface}} \{}
\DoxyCodeLine{147  \textcolor{keyword}{public}:}
\DoxyCodeLine{148   \textcolor{keyword}{virtual} \mbox{\hyperlink{classtesting_1_1_test_part_result_reporter_interface}{\string~TestPartResultReporterInterface}}() \{\}}
\DoxyCodeLine{149 }
\DoxyCodeLine{150   \textcolor{keyword}{virtual} \textcolor{keywordtype}{void} ReportTestPartResult(\textcolor{keyword}{const} \mbox{\hyperlink{classtesting_1_1_test_part_result}{TestPartResult}}\& result) = 0;}
\DoxyCodeLine{151 \};}
\DoxyCodeLine{152 }
...
\DoxyCodeLine{161 \textcolor{keyword}{class }GTEST\_API\_ \mbox{\hyperlink{classtesting_1_1internal_1_1_has_new_fatal_failure_helper}{HasNewFatalFailureHelper}}}
\DoxyCodeLine{162     : \textcolor{keyword}{public} \mbox{\hyperlink{classtesting_1_1_test_part_result_reporter_interface}{TestPartResultReporterInterface}} \{}
\DoxyCodeLine{163  \textcolor{keyword}{public}:}
\DoxyCodeLine{164   \mbox{\hyperlink{classtesting_1_1internal_1_1_has_new_fatal_failure_helper}{HasNewFatalFailureHelper}}();}
\DoxyCodeLine{165   \textcolor{keyword}{virtual} \mbox{\hyperlink{classtesting_1_1internal_1_1_has_new_fatal_failure_helper}{\string~HasNewFatalFailureHelper}}();}
\DoxyCodeLine{166   \textcolor{keyword}{virtual} \textcolor{keywordtype}{void} ReportTestPartResult(\textcolor{keyword}{const} \mbox{\hyperlink{classtesting_1_1_test_part_result}{TestPartResult}}\& result);}
...
\DoxyCodeLine{170   \mbox{\hyperlink{classtesting_1_1_test_part_result_reporter_interface}{TestPartResultReporterInterface}}* original\_reporter\_;}
\DoxyCodeLine{171 }
\DoxyCodeLine{172   GTEST\_DISALLOW\_COPY\_AND\_ASSIGN\_(\mbox{\hyperlink{classtesting_1_1internal_1_1_has_new_fatal_failure_helper}{HasNewFatalFailureHelper}});}
\DoxyCodeLine{173 \};}
\DoxyCodeLine{174 }
