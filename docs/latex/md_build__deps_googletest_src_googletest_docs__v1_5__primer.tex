...
{\itshape Note\+:} We sometimes refer to Google C++ Testing Framework informally as {\itshape Google Test}.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__primer_autotoc_md906}{}\doxysection{Setting up a New Test Project}\label{md_build__deps_googletest_src_googletest_docs__v1_5__primer_autotoc_md906}
...
If you still have questions, take a look at how Google Test\textquotesingle{}s own tests are built and use them as examples.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__primer_autotoc_md907}{}\doxysection{Basic Concepts}\label{md_build__deps_googletest_src_googletest_docs__v1_5__primer_autotoc_md907}
...
We\textquotesingle{}ll now explain how to write a test program, starting at the individual assertion level and building up to tests and test cases.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__primer_autotoc_md908}{}\doxysection{Assertions}\label{md_build__deps_googletest_src_googletest_docs__v1_5__primer_autotoc_md908}
...
Anything that can be streamed to an {\ttfamily ostream} can be streamed to an assertion macro--in particular, C strings and {\ttfamily string} objects. If a wide string ({\ttfamily wchar\+\_\+t$\ast$}, {\ttfamily TCHAR$\ast$} in {\ttfamily UNICODE} mode on Windows, or {\ttfamily std\+::wstring}) is streamed to an assertion, it will be translated to UTF-\/8 when printed.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__primer_autotoc_md909}{}\doxysubsection{Basic Assertions}\label{md_build__deps_googletest_src_googletest_docs__v1_5__primer_autotoc_md909}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__primer_autotoc_md910}{}\doxysubsection{Binary Comparison}\label{md_build__deps_googletest_src_googletest_docs__v1_5__primer_autotoc_md910}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__primer_autotoc_md911}{}\doxysubsection{String Comparison}\label{md_build__deps_googletest_src_googletest_docs__v1_5__primer_autotoc_md911}
...
See also\+: For more string comparison tricks (substring, prefix, suffix, and regular expression matching, for example), see the \mbox{[}Advanced\+Guide Advanced Google Test Guide\mbox{]}.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__primer_autotoc_md912}{}\doxysection{Simple Tests}\label{md_build__deps_googletest_src_googletest_docs__v1_5__primer_autotoc_md912}
To create a test\+:
\begin{DoxyEnumerate}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__primer_autotoc_md913}{}\doxysection{Test Fixtures\+: Using the Same Data Configuration for Multiple Tests}\label{md_build__deps_googletest_src_googletest_docs__v1_5__primer_autotoc_md913}
...
{\itshape Note}\+: Google Test automatically saves all {\itshape Google Test} flags when a test object is constructed, and restores them when it is destructed.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__primer_autotoc_md914}{}\doxysection{Invoking the Tests}\label{md_build__deps_googletest_src_googletest_docs__v1_5__primer_autotoc_md914}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__primer_autotoc_md915}{}\doxysection{Writing the main() Function}\label{md_build__deps_googletest_src_googletest_docs__v1_5__primer_autotoc_md915}
...
But maybe you think that writing all those main() functions is too much work? We agree with you completely and that\textquotesingle{}s why Google Test provides a basic implementation of main(). If it fits your needs, then just link your test with gtest\+\_\+main library and you are good to go.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__primer_autotoc_md916}{}\doxysubsection{Important note for Visual C++ users}\label{md_build__deps_googletest_src_googletest_docs__v1_5__primer_autotoc_md916}
...
There is one more pitfall, though. If you use Google Test as a static library (that\textquotesingle{}s how it is defined in gtest.\+vcproj) your tests must also reside in a static library. If you have to have them in a DLL, you {\itshape must} change Google Test to build into a DLL as well. Otherwise your tests will not run correctly or will not run at all. The general conclusion here is\+: make your life easier -\/ do not write your tests in libraries!\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__primer_autotoc_md917}{}\doxysection{Where to Go from Here}\label{md_build__deps_googletest_src_googletest_docs__v1_5__primer_autotoc_md917}
Congratulations! You\textquotesingle{}ve learned the Google Test basics. You can start writing and running Google Test tests, read some \mbox{\hyperlink{md_build__deps_googletest_src_googletest_docs__samples}{samples}}, or continue with \mbox{\hyperlink{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide}{Advanced\+Guide}}, which describes many more useful Google Test features.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__primer_autotoc_md918}{}\doxysection{Known Limitations}\label{md_build__deps_googletest_src_googletest_docs__v1_5__primer_autotoc_md918}
