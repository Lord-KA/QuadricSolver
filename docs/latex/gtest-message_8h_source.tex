...
\DoxyCodeLine{55 \textcolor{keywordtype}{void} operator<<(\textcolor{keyword}{const} testing::internal::Secret\&, \textcolor{keywordtype}{int});}
\DoxyCodeLine{56 }
...
\DoxyCodeLine{85 \textcolor{keyword}{class }GTEST\_API\_ \mbox{\hyperlink{classtesting_1_1_message}{Message}} \{}
...
\DoxyCodeLine{93   \mbox{\hyperlink{classtesting_1_1_message}{Message}}();}
\DoxyCodeLine{94 }
\DoxyCodeLine{95   \textcolor{comment}{// Copy constructor.}}
\DoxyCodeLine{96   \mbox{\hyperlink{classtesting_1_1_message}{Message}}(\textcolor{keyword}{const} \mbox{\hyperlink{classtesting_1_1_message}{Message}}\& msg) : ss\_(new ::std::stringstream) \{  \textcolor{comment}{// NOLINT}}
\DoxyCodeLine{97     *ss\_ << msg.GetString();}
\DoxyCodeLine{98   \}}
\DoxyCodeLine{99 }
\DoxyCodeLine{100   \textcolor{comment}{// Constructs a Message from a C-\/string.}}
\DoxyCodeLine{101   \textcolor{keyword}{explicit} \mbox{\hyperlink{classtesting_1_1_message}{Message}}(\textcolor{keyword}{const} \textcolor{keywordtype}{char}* str) : ss\_(new ::std::stringstream) \{}
...
\DoxyCodeLine{108   \textcolor{keyword}{inline} \mbox{\hyperlink{classtesting_1_1_message}{Message}}\& operator <<(\textcolor{keyword}{const} T\& value) \{}
...
\DoxyCodeLine{115   \textcolor{keyword}{inline} \mbox{\hyperlink{classtesting_1_1_message}{Message}}\& operator <<(\textcolor{keyword}{const} T\& val) \{}
...
\DoxyCodeLine{149   \textcolor{keyword}{inline} \mbox{\hyperlink{classtesting_1_1_message}{Message}}\& operator <<(T* \textcolor{keyword}{const}\& pointer) \{  \textcolor{comment}{// NOLINT}}
...
\DoxyCodeLine{165   \mbox{\hyperlink{classtesting_1_1_message}{Message}}\& operator <<(BasicNarrowIoManip val) \{}
...
\DoxyCodeLine{171   \mbox{\hyperlink{classtesting_1_1_message}{Message}}\& operator <<(\textcolor{keywordtype}{bool} b) \{}
...
\DoxyCodeLine{177   \mbox{\hyperlink{classtesting_1_1_message}{Message}}\& operator <<(\textcolor{keyword}{const} \textcolor{keywordtype}{wchar\_t}* wide\_c\_str);}
\DoxyCodeLine{178   \mbox{\hyperlink{classtesting_1_1_message}{Message}}\& operator <<(\textcolor{keywordtype}{wchar\_t}* wide\_c\_str);}
\DoxyCodeLine{179 }
...
\DoxyCodeLine{183   \mbox{\hyperlink{classtesting_1_1_message}{Message}}\& operator <<(const ::std::wstring\& wstr);}
...
\DoxyCodeLine{189   \mbox{\hyperlink{classtesting_1_1_message}{Message}}\& operator <<(const ::wstring\& wstr);}
...
\DoxyCodeLine{228   \textcolor{keywordtype}{void} operator=(\textcolor{keyword}{const} \mbox{\hyperlink{classtesting_1_1_message}{Message}}\&);}
\DoxyCodeLine{229 \};}
\DoxyCodeLine{230 }
\DoxyCodeLine{231 \textcolor{comment}{// Streams a Message to an ostream.}}
\DoxyCodeLine{232 \textcolor{keyword}{inline} std::ostream\& operator <<(std::ostream\& os, \textcolor{keyword}{const} \mbox{\hyperlink{classtesting_1_1_message}{Message}}\& sb) \{}
