\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md331}{}\doxysection{Mocking a Normal Class}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md331}
Given 
\begin{DoxyCode}{0}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md332}{}\doxysection{Mocking a Class Template}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md332}
To mock 
\begin{DoxyCode}{0}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md333}{}\doxysection{Specifying Calling Conventions for Mock Functions}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md333}
...
\end{DoxyCode}
 where {\ttfamily STDMETHODCALLTYPE} is defined by {\ttfamily \texorpdfstring{$<$}{<}objbase.\+h\texorpdfstring{$>$}{>}} on Windows.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md334}{}\doxysection{Using Mocks in Tests}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md334}
The typical flow is\+:
\begin{DoxyEnumerate}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md335}{}\doxysection{Setting Default Actions}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md335}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md336}{}\doxysection{Setting Expectations}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md336}
...
A method with no {\ttfamily EXPECT\+\_\+\+CALL()} is free to be invoked {\itshape any number of times}, and the default action will be taken each time.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md337}{}\doxysection{Matchers}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md337}
...
Built-\/in matchers (where {\ttfamily argument} is the function argument) are divided into several categories\+:\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md338}{}\doxysubsection{Wildcard}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md338}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md339}{}\doxysubsection{Generic Comparison}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md339}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
These matchers use ULP-\/based comparison (the same as used in \href{http://code.google.com/p/googletest/}{\texttt{ Google Test}}). They automatically pick a reasonable error bound based on the absolute value of the expected value. {\ttfamily Double\+Eq()} and {\ttfamily Float\+Eq()} conform to the IEEE standard, which requires comparing two Na\+Ns for equality to return false. The {\ttfamily Nan\+Sensitive$\ast$} version instead treats two Na\+Ns as equal, which is often what a user wants.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md341}{}\doxysubsection{String Matchers}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md341}
...
{\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} use the regular expression syntax defined \href{http://code.google.com/p/googletest/wiki/V1_6_AdvancedGuide\#Regular_Expression_Syntax}{\texttt{ here}}. {\ttfamily Str\+Case\+Eq()}, {\ttfamily Str\+Case\+Ne()}, {\ttfamily Str\+Eq()}, and {\ttfamily Str\+Ne()} work for wide strings as well.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md342}{}\doxysubsection{Container Matchers}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md342}
...
where the array may be multi-\/dimensional (i.\+e. its elements can be arrays).\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md343}{}\doxysubsection{Member Matchers}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md343}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md344}{}\doxysubsection{Matching the Result of a Function or Functor}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md344}
$\vert${\ttfamily Result\+Of(f, m)}$\vert${\ttfamily f(argument)} matches matcher {\ttfamily m}, where {\ttfamily f} is a function or functor.$\vert$ $\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md345}{}\doxysubsection{Pointer Matchers}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md345}
$\vert${\ttfamily Pointee(m)}$\vert${\ttfamily argument} (either a smart pointer or a raw pointer) points to a value that matches matcher {\ttfamily m}.$\vert$ $\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md346}{}\doxysubsection{Multiargument Matchers}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md346}
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md347}{}\doxysubsection{Composite Matchers}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md347}
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md348}{}\doxysubsection{Adapters for Matchers}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md348}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md349}{}\doxysubsection{Matchers as Predicates}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md349}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md350}{}\doxysubsection{Defining Matchers}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md350}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{DoxyEnumerate}\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md351}{}\doxysubsection{Matchers as Test Assertions}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md351}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md352}{}\doxysection{Actions}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md352}
{\bfseries{Actions}} specify what a mock function should do when invoked.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md353}{}\doxysubsection{Returning a Value}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md353}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md354}{}\doxysubsection{Side Effects}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md354}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md355}{}\doxysubsection{Using a Function or a Functor as an Action}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md355}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{DoxyCode}
 calls the mock function\textquotesingle{}s \#2 argument, passing to it {\ttfamily 5} and {\ttfamily string(\char`\"{}\+Hi\char`\"{})} by value, and {\ttfamily foo} by reference.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md356}{}\doxysubsection{Default Action}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md356}
...
{\bfseries{Note\+:}} due to technical reasons, {\ttfamily Do\+Default()} cannot be used inside a composite action -\/ trying to do so will result in a run-\/time error.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md357}{}\doxysubsection{Composite Actions}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md357}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md358}{}\doxysubsection{Defining Actions}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md358}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
The {\ttfamily ACTION$\ast$} macros cannot be used inside a function or class.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md359}{}\doxysection{Cardinalities}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md359}
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md360}{}\doxysection{Expectation Order}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md360}
By default, the expectations can be matched in {\itshape any} order. If some or all expectations must be matched in a given order, there are two ways to specify it. They can be used either independently or together.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md361}{}\doxysubsection{The After Clause}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md361}
...
\end{DoxyCode}
 says that all expected calls in the scope of {\ttfamily dummy} must occur in strict order. The name {\ttfamily dummy} is irrelevant.)\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md363}{}\doxysection{Verifying and Resetting a Mock}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md363}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md364}{}\doxysection{Mock Classes}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md364}
...
\end{DoxyCode}
 See this \href{http://code.google.com/p/googlemock/wiki/V1_6_CookBook\#Using_Check_Points}{\texttt{ recipe}} for one application of it.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md365}{}\doxysection{Flags}\label{md_build__deps_googletest_src_googlemock_docs_v1_6__cheat_sheet_autotoc_md365}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
