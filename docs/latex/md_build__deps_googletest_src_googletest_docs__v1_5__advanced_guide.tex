Now that you have read \mbox{\hyperlink{md_build__deps_googletest_src_googletest_docs__v1_5__primer}{Primer}} and learned how to write tests using Google Test, it\textquotesingle{}s time to learn some new tricks. This document will show you more assertions as well as how to construct complex failure messages, propagate fatal failures, reuse and speed up your test fixtures, and use various flags with your tests.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md803}{}\doxysection{More Assertions}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md803}
This section covers some less frequently used, but still significant, assertions.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md804}{}\doxysubsection{Explicit Success and Failure}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md804}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md805}{}\doxysubsection{Exception Assertions}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md805}
...
{\itshape Availability}\+: Linux, Windows, Mac; since version 1.\+1.\+0.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md806}{}\doxysubsection{Predicate Assertions for Better Error Messages}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md806}
...
Google Test gives you three different options to solve this problem\+:\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md807}{}\doxysubsubsection{Using an Existing Boolean Function}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md807}
...
{\itshape Availability}\+: Linux, Windows, Mac\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md808}{}\doxysubsubsection{Using a Function That Returns an Assertion\+Result}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md808}
...
{\itshape Availability}\+: Linux, Windows, Mac; since version 1.\+4.\+1.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md809}{}\doxysubsubsection{Using a Predicate-\/\+Formatter}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md809}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md810}{}\doxysubsection{Floating-\/\+Point Comparison}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md810}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md812}{}\doxysubsubsection{Floating-\/\+Point Predicate-\/\+Format Functions}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md812}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md813}{}\doxysubsection{Windows HRESULT assertions}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md813}
...
{\itshape Availability}\+: Windows.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md814}{}\doxysubsection{Type Assertions}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md814}
...
{\itshape Availability\+:} Linux, Windows, Mac; since version 1.\+3.\+0.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md815}{}\doxysubsection{Assertion Placement}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md815}
...
If you want to test {\ttfamily EXPECT\+\_\+$\ast$()/\+ASSERT\+\_\+$\ast$()} failures in your test code, see \href{\#catching-failures}{\texttt{ Catching Failures}}.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md817}{}\doxysubsection{How to Write a Death Test}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md817}
...
{\itshape Availability\+:} Linux, Windows (requires MSVC 8.\+0 or above), Cygwin, and Mac (the latter three are supported since v1.\+3.\+0). {\ttfamily (ASSERT$\vert$\+EXPECT)\+\_\+\+DEATH\+\_\+\+IF\+\_\+\+SUPPORTED} are new in v1.\+4.\+0.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md818}{}\doxysubsection{Regular Expression Syntax}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md818}
...
If the death test statement runs to completion without dying, the child process will nonetheless terminate, and the assertion fails.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md820}{}\doxysubsection{Death Tests And Threads}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md820}
...
It\textquotesingle{}s perfectly fine to create threads inside a death test statement; they are executed in a separate process and cannot affect the parent.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md821}{}\doxysubsection{Death Test Styles}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md821}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md822}{}\doxysubsection{Caveats}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md822}
...
Despite the improved thread safety afforded by the \char`\"{}threadsafe\char`\"{} style of death test, thread problems such as deadlock are still possible in the presence of handlers registered with {\ttfamily pthread\+\_\+atfork(3)}.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md823}{}\doxysection{Using Assertions in Sub-\/routines}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md823}
\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md824}{}\doxysubsection{Adding Traces to Assertions}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md824}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md825}{}\doxysubsection{Propagating Fatal Failures}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md825}
...
{\itshape Availability\+:} Linux, Windows, Mac. Assertions from multiple threads are currently not supported.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md827}{}\doxysubsubsection{Checking for Failures in the Current Test}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md827}
...
{\itshape Availability\+:} Linux, Windows, Mac. {\ttfamily Has\+Nonfatal\+Failure()} and {\ttfamily Has\+Failure()} are available since version 1.\+4.\+0.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md828}{}\doxysection{Logging Additional Information}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md828}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md829}{}\doxysection{Sharing Resources Between Tests in the Same Test Case}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md829}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md830}{}\doxysection{Global Set-\/\+Up and Tear-\/\+Down}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md830}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md831}{}\doxysection{Value Parameterized Tests}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md831}
...
\end{DoxyItemize}\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md832}{}\doxysubsection{How to Write Value-\/\+Parameterized Tests}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md832}
...
{\itshape Availability}\+: Linux, Windows (requires MSVC 8.\+0 or above), Mac; since version 1.\+2.\+0.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md833}{}\doxysubsection{Creating Value-\/\+Parameterized Abstract Tests}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md833}
...
Once they are defined, you can instantiate them by including {\ttfamily foo\+\_\+param\+\_\+test.\+h}, invoking {\ttfamily INSTANTIATE\+\_\+\+TEST\+\_\+\+CASE\+\_\+\+P()}, and linking with {\ttfamily foo\+\_\+param\+\_\+test.\+cc}. You can instantiate the same abstract test case multiple times, possibly in different source files.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md834}{}\doxysection{Typed Tests}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md834}
...
{\itshape Availability\+:} Linux, Windows (requires MSVC 8.\+0 or above), Mac; since version 1.\+1.\+0.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md835}{}\doxysection{Type-\/\+Parameterized Tests}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md835}
...
{\itshape Availability\+:} Linux, Windows (requires MSVC 8.\+0 or above), Mac; since version 1.\+1.\+0.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md836}{}\doxysection{Testing Private Code}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md836}
...
\end{DoxyItemize}\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md837}{}\doxysubsection{Static Functions}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md837}
...
However, a better approach is to move the private code into the {\ttfamily foo\+::internal} namespace, where {\ttfamily foo} is the namespace your project normally uses, and put the private declarations in a {\ttfamily $\ast$-\/internal.h} file. Your production {\ttfamily .cc} files and your tests are allowed to include this internal header, but your clients are not. This way, you can fully test your internal implementation without leaking it to your clients.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md838}{}\doxysubsection{Private Class Members}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md838}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md839}{}\doxysection{Catching Failures}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md839}
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md840}{}\doxysection{Getting the Current Test\textquotesingle{}s Name}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md840}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md841}{}\doxysection{Extending Google Test by Handling Test Events}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md841}
...
{\itshape Availability\+:} Linux, Windows, Mac; since v1.\+4.\+0.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md842}{}\doxysubsection{Defining Event Listeners}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md842}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md843}{}\doxysubsection{Using Event Listeners}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md843}
...
You may append more than one listener to the list. When an {\ttfamily On$\ast$\+Start()} or {\ttfamily On\+Test\+Part\+Result()} event is fired, the listeners will receive it in the order they appear in the list (since new listeners are added to the end of the list, the default text printer and the default XML generator will receive the event first). An {\ttfamily On$\ast$\+End()} event will be received by the listeners in the {\itshape reverse} order. This allows output by listeners added later to be framed by output from listeners added earlier.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md844}{}\doxysubsection{Generating Failures in Listeners}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md844}
...
We have a sample of failure-\/raising listener \href{../samples/sample10_unittest.cc}{\texttt{ here}}.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md845}{}\doxysection{Running Test Programs\+: Advanced Options}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md845}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md846}{}\doxysubsection{Selecting Tests}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md846}
This section shows various options for choosing which tests to run.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md847}{}\doxysubsubsection{Listing Test Names}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md847}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md848}{}\doxysubsubsection{Running a Subset of the Tests}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md848}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md849}{}\doxysubsubsection{Temporarily Disabling Tests}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md849}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md850}{}\doxysubsubsection{Temporarily Enabling Disabled Tests}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md850}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md851}{}\doxysubsection{Repeating the Tests}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md851}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md852}{}\doxysubsection{Shuffling the Tests}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md852}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md853}{}\doxysubsection{Controlling Test Output}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md853}
{\itshape  This section teaches how to tweak the way test results are reported.}

{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md854}{}\doxysubsubsection{Colored Terminal Output}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md854}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md855}{}\doxysubsubsection{Suppressing the Elapsed Time}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md855}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md856}{}\doxysubsubsection{Generating an XML Report}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md856}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md857}{}\doxysubsection{Controlling How Failures Are Reported}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md857}
{\itshape  }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md858}{}\doxysubsubsection{Turning Assertion Failures into Break-\/\+Points}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md858}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md859}{}\doxysubsubsection{Suppressing Pop-\/ups Caused by Exceptions}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md859}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md860}{}\doxysubsubsection{Letting Another Testing Framework Drive}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md860}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md861}{}\doxysubsection{Distributing Test Functions to Multiple Machines}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md861}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md862}{}\doxysection{Fusing Google Test Source Files}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md862}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md863}{}\doxysection{Where to Go from Here}\label{md_build__deps_googletest_src_googletest_docs__v1_5__advanced_guide_autotoc_md863}
{\itshape  Congratulations! You\textquotesingle{}ve now learned more advanced Google Test tools and are ready to tackle more complex testing tasks. If you want to dive even deeper, you can read the \mbox{\hyperlink{md_build__deps_googletest_src_googletest_docs__v1_5__f_a_q}{FAQ}}. }