...
\DoxyCodeLine{59 \textcolor{keyword}{class }\mbox{\hyperlink{classtesting_1_1_cardinality_interface}{CardinalityInterface}} \{}
\DoxyCodeLine{60  \textcolor{keyword}{public}:}
\DoxyCodeLine{61   \textcolor{keyword}{virtual} \mbox{\hyperlink{classtesting_1_1_cardinality_interface}{\string~CardinalityInterface}}() \{\}}
\DoxyCodeLine{62 }
...
\DoxyCodeLine{83 \textcolor{keyword}{class }GTEST\_API\_ \mbox{\hyperlink{classtesting_1_1_cardinality}{Cardinality}} \{}
...
\DoxyCodeLine{87   \mbox{\hyperlink{classtesting_1_1_cardinality}{Cardinality}}() \{\}}
\DoxyCodeLine{88 }
\DoxyCodeLine{89   \textcolor{comment}{// Constructs a Cardinality from its implementation.}}
\DoxyCodeLine{90   \textcolor{keyword}{explicit} \mbox{\hyperlink{classtesting_1_1_cardinality}{Cardinality}}(\textcolor{keyword}{const} \mbox{\hyperlink{classtesting_1_1_cardinality_interface}{CardinalityInterface}}* impl) : impl\_(impl) \{\}}
\DoxyCodeLine{91 }
...
\DoxyCodeLine{126 GTEST\_API\_ \mbox{\hyperlink{classtesting_1_1_cardinality}{Cardinality}} AtLeast(\textcolor{keywordtype}{int} n);}
\DoxyCodeLine{127 }
\DoxyCodeLine{128 \textcolor{comment}{// Creates a cardinality that allows at most n calls.}}
\DoxyCodeLine{129 GTEST\_API\_ \mbox{\hyperlink{classtesting_1_1_cardinality}{Cardinality}} AtMost(\textcolor{keywordtype}{int} n);}
\DoxyCodeLine{130 }
\DoxyCodeLine{131 \textcolor{comment}{// Creates a cardinality that allows any number of calls.}}
\DoxyCodeLine{132 GTEST\_API\_ \mbox{\hyperlink{classtesting_1_1_cardinality}{Cardinality}} AnyNumber();}
\DoxyCodeLine{133 }
\DoxyCodeLine{134 \textcolor{comment}{// Creates a cardinality that allows between min and max calls.}}
\DoxyCodeLine{135 GTEST\_API\_ \mbox{\hyperlink{classtesting_1_1_cardinality}{Cardinality}} Between(\textcolor{keywordtype}{int} min, \textcolor{keywordtype}{int} max);}
\DoxyCodeLine{136 }
\DoxyCodeLine{137 \textcolor{comment}{// Creates a cardinality that allows exactly n calls.}}
\DoxyCodeLine{138 GTEST\_API\_ \mbox{\hyperlink{classtesting_1_1_cardinality}{Cardinality}} Exactly(\textcolor{keywordtype}{int} n);}
\DoxyCodeLine{139 }
\DoxyCodeLine{140 \textcolor{comment}{// Creates a cardinality from its implementation.}}
\DoxyCodeLine{141 \textcolor{keyword}{inline} \mbox{\hyperlink{classtesting_1_1_cardinality}{Cardinality}} MakeCardinality(\textcolor{keyword}{const} \mbox{\hyperlink{classtesting_1_1_cardinality_interface}{CardinalityInterface}}* c) \{}
\DoxyCodeLine{142   \textcolor{keywordflow}{return} \mbox{\hyperlink{classtesting_1_1_cardinality}{Cardinality}}(c);}
\DoxyCodeLine{143 \}}
\DoxyCodeLine{144 }
