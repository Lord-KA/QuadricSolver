({\bfseries{Note\+:}} If you get compiler errors that you don\textquotesingle{}t understand, be sure to consult Google Mock Doctor.)\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md291}{}\doxysection{What Is Google C++ Mocking Framework?}\label{md_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md291}
...
\end{DoxyEnumerate}\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md292}{}\doxysection{Why Google Mock?}\label{md_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md292}
...
\end{DoxyItemize}\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md293}{}\doxysection{Getting Started}\label{md_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md293}
Using Google \mbox{\hyperlink{class_mock}{Mock}} is easy! Inside your C++ source file, just {\ttfamily \#include} {\ttfamily \texorpdfstring{$<$}{<}\mbox{\hyperlink{gtest_8h_source}{gtest/gtest.\+h}}\texorpdfstring{$>$}{>}} and {\ttfamily \texorpdfstring{$<$}{<}\mbox{\hyperlink{gmock_8h_source}{gmock/gmock.\+h}}\texorpdfstring{$>$}{>}}, and you are ready to go.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md294}{}\doxysection{A Case for Mock Turtles}\label{md_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md294}
...
Admittedly, this test is contrived and doesn\textquotesingle{}t do much. You can easily achieve the same effect without using Google \mbox{\hyperlink{class_mock}{Mock}}. However, as we shall reveal soon, Google \mbox{\hyperlink{class_mock}{Mock}} allows you to do {\itshape much more} with the mocks.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md299}{}\doxysubsection{Using Google Mock with Any Testing Framework}\label{md_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md299}
...
If this turns out to be too much work, we suggest that you stick with Google Test, which works with Google \mbox{\hyperlink{class_mock}{Mock}} seamlessly (in fact, it is technically part of Google \mbox{\hyperlink{class_mock}{Mock}}.). If there is a reason that you cannot use Google Test, please let us know.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md300}{}\doxysection{Setting Expectations}\label{md_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md300}
The key to using a mock object successfully is to set the {\itshape right expectations} on it. If you set the expectations too strict, your test will fail as the result of unrelated changes. If you set them too loose, bugs can slip through. You want to do it just right such that your test can catch exactly the kind of bugs you intend it to catch. Google \mbox{\hyperlink{class_mock}{Mock}} provides the necessary means for you to do it \char`\"{}just right.\char`\"{}\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md301}{}\doxysubsection{General Syntax}\label{md_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md301}
...
This checks that the turtle will be told to go forward by at least 100 units.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md303}{}\doxysubsection{Cardinalities\+: How Many Times Will It Be Called?}\label{md_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md303}
...
(What if you care about the relative order of some of the calls, but not all of them? Can you specify an arbitrary partial order? The answer is ... yes! If you are impatient, the details can be found in the Cook\+Book.)\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md307}{}\doxysubsection{All Expectations Are Sticky (\+Unless Said Otherwise)}\label{md_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md307}
...
In Google \mbox{\hyperlink{class_mock}{Mock}}, if you are not interested in a method, just don\textquotesingle{}t say anything about it. If a call to this method occurs, you\textquotesingle{}ll see a warning in the test output, but it won\textquotesingle{}t be a failure.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md309}{}\doxysection{What Now?}\label{md_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md309}
