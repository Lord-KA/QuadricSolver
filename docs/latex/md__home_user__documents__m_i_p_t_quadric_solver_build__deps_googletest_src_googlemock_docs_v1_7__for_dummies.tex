({\bfseries{Note\+:}} If you get compiler errors that you don\textquotesingle{}t understand, be sure to consult \href{http://code.google.com/p/googlemock/wiki/V1_7_FrequentlyAskedQuestions\#How_am_I_supposed_to_make_sense_of_these_horrible_template_error}{\texttt{ Google Mock Doctor}}.)\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md590}{}\doxysection{What Is Google C++ Mocking Framework?}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md590}
...
\end{DoxyEnumerate}\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md591}{}\doxysection{Why Google Mock?}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md591}
...
\end{DoxyItemize}\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md592}{}\doxysection{Getting Started}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md592}
Using Google \mbox{\hyperlink{class_mock}{Mock}} is easy! Inside your C++ source file, just {\ttfamily \#include} {\ttfamily \char`\"{}gtest/gtest.\+h\char`\"{}} and {\ttfamily \char`\"{}gmock/gmock.\+h\char`\"{}}, and you are ready to go.\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md593}{}\doxysection{A Case for Mock Turtles}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md593}
...
Your program will normally use a real implementation of this interface. In tests, you can use a mock implementation instead. This allows you to easily check what drawing primitives your program is calling, with what arguments, and in which order. Tests written this way are much more robust (they won\textquotesingle{}t break because your new machine does anti-\/aliasing differently), easier to read and maintain (the intent of a test is expressed in the code, not in some binary images), and run {\itshape much, much faster}.\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md594}{}\doxysection{Writing the Mock Class}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md594}
If you are lucky, the mocks you need to use have already been implemented by some nice people. If, however, you find yourself in the position to write a mock class, relax -\/ Google \mbox{\hyperlink{class_mock}{Mock}} turns this task into a fun game! (Well, almost.)\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md595}{}\doxysubsection{How to Define It}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md595}
...
Admittedly, this test is contrived and doesn\textquotesingle{}t do much. You can easily achieve the same effect without using Google \mbox{\hyperlink{class_mock}{Mock}}. However, as we shall reveal soon, Google \mbox{\hyperlink{class_mock}{Mock}} allows you to do {\itshape much more} with the mocks.\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md598}{}\doxysubsection{Using Google Mock with Any Testing Framework}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md598}
...
If this turns out to be too much work, we suggest that you stick with Google Test, which works with Google \mbox{\hyperlink{class_mock}{Mock}} seamlessly (in fact, it is technically part of Google \mbox{\hyperlink{class_mock}{Mock}}.). If there is a reason that you cannot use Google Test, please let us know.\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md599}{}\doxysection{Setting Expectations}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md599}
The key to using a mock object successfully is to set the {\itshape right expectations} on it. If you set the expectations too strict, your test will fail as the result of unrelated changes. If you set them too loose, bugs can slip through. You want to do it just right such that your test can catch exactly the kind of bugs you intend it to catch. Google \mbox{\hyperlink{class_mock}{Mock}} provides the necessary means for you to do it \char`\"{}just right.\char`\"{}\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md600}{}\doxysubsection{General Syntax}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md600}
...
{\bfseries{Note\+:}} Why do we use a macro to do this? It serves two purposes\+: first it makes expectations easily identifiable (either by {\ttfamily grep} or by a human reader), and second it allows Google \mbox{\hyperlink{class_mock}{Mock}} to include the source file location of a failed expectation in messages, making debugging easier.\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md601}{}\doxysubsection{Matchers\+: What Arguments Do We Expect?}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md601}
...
This checks that the turtle will be told to go forward by at least 100 units.\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md602}{}\doxysubsection{Cardinalities\+: How Many Times Will It Be Called?}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md602}
...
Obviously {\ttfamily turtle.\+Get\+Y()} is expected to be called four times. But if you think it will return 100 every time, think twice! Remember that one {\ttfamily Will\+Once()} clause will be consumed each time the function is invoked and the default action will be taken afterwards. So the right answer is that {\ttfamily turtle.\+Get\+Y()} will return 100 the first time, but {\bfseries{return 0 from the second time on}}, as returning 0 is the default action for {\ttfamily int} functions.\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md604}{}\doxysubsection{Using Multiple Expectations}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md604}
...
(What if you care about the relative order of some of the calls, but not all of them? Can you specify an arbitrary partial order? The answer is ... yes! If you are impatient, the details can be found in the Cook\+Book.)\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md606}{}\doxysubsection{All Expectations Are Sticky (\+Unless Said Otherwise)}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md606}
...
By the way, the other situation where an expectation may {\itshape not} be sticky is when it\textquotesingle{}s in a sequence -\/ as soon as another expectation that comes after it in the sequence has been used, it automatically retires (and will never be used to match any call).\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md607}{}\doxysubsection{Uninteresting Calls}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md607}
...
In Google \mbox{\hyperlink{class_mock}{Mock}}, if you are not interested in a method, just don\textquotesingle{}t say anything about it. If a call to this method occurs, you\textquotesingle{}ll see a warning in the test output, but it won\textquotesingle{}t be a failure.\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md608}{}\doxysection{What Now?}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_7__for_dummies_autotoc_md608}
