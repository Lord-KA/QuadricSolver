This page discusses the design of new Google \mbox{\hyperlink{class_mock}{Mock}} features.\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md113}{}\doxysection{Macros for Defining Actions}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md113}
\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md114}{}\doxysubsection{Problem}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md114}
Due to the lack of closures in C++, it currently requires some non-\/trivial effort to define a custom action in Google \mbox{\hyperlink{class_mock}{Mock}}. For example, suppose you want to \char`\"{}increment the value pointed to by the second argument of the mock function and return it\char`\"{}, you could write\+:
...
Our goal is to allow defining custom actions with the least amount of boiler-\/plate C++ requires.\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md115}{}\doxysubsection{Solution}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md115}
...
\end{longtabu}
\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md116}{}\doxysubsection{Parameterized actions}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md116}
...
You can view {\ttfamily ACTION} as a degenerated parameterized action where the number of parameters is 0.\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md117}{}\doxysubsection{Advanced Usages}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md117}
\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md118}{}\doxysubsubsection{Overloading Actions}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md118}
...
\end{DoxyCode}
\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md119}{}\doxysubsubsection{Restricting the Type of an Argument or Parameter}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md119}
...
\end{DoxyCode}
 where {\ttfamily Static\+Assert\+Type\+Eq} is a compile-\/time assertion we plan to add to Google Test (the name is chosen to match {\ttfamily static\+\_\+assert} in C++0x).\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md120}{}\doxysubsubsection{Using the ACTION Object\textquotesingle{}s Type}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md120}
...
Note that we have to pick different suffixes ({\ttfamily Action}, {\ttfamily ActionP}, {\ttfamily Action\+P2}, and etc) for actions with different numbers of parameters, or the action definitions cannot be overloaded on the number of parameters.\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md121}{}\doxysubsection{When to Use}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md121}
While the new macros are very convenient, please also consider other means of implementing actions (e.\+g. via {\ttfamily Action\+Interface} or {\ttfamily Make\+Polymorphic\+Action()}), especially if you need to use the defined action a lot. While the other approaches require more work, they give you more control on the types of the mock function arguments and the action parameters, which in general leads to better compiler error messages that pay off in the long run. They also allow overloading actions based on parameter types, as opposed to just the number of parameters.\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md122}{}\doxysubsection{Related Work}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md122}
...
{\ttfamily ACTION$\ast$} avoid all these problems.\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md123}{}\doxysubsection{Future Improvements}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md123}
...
C++0x will also support lambda expressions. When they become available, we may want to support using lambdas as actions.\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md124}{}\doxysection{Macros for Defining Matchers}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md124}
