...
\label{widget_8h_source}\index{build/\_deps/googletest-\/src/googletest/xcode/Samples/FrameworkSample/widget.h@{build/\_deps/googletest-\/src/googletest/xcode/Samples/FrameworkSample/widget.h}}
...
\DoxyCodeLine{41 }
\DoxyCodeLine{42 \textcolor{keyword}{class }\mbox{\hyperlink{class_widget}{Widget}} \{}
\DoxyCodeLine{43  \textcolor{keyword}{public}:}
\DoxyCodeLine{44   \mbox{\hyperlink{class_widget}{Widget}}(\textcolor{keywordtype}{int} number, \textcolor{keyword}{const} std::string\& name);}
\DoxyCodeLine{45   \mbox{\hyperlink{class_widget}{\string~Widget}}();}
\DoxyCodeLine{46 }
