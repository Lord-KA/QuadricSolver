...
{\bfseries{Note\+:}} Google \mbox{\hyperlink{class_mock}{Mock}} lives in the {\ttfamily testing} name space. For readability, it is recommended to write {\ttfamily using \+::testing\+::\+Foo;} once in your file before using the name {\ttfamily Foo} defined by Google \mbox{\hyperlink{class_mock}{Mock}}. We omit such {\ttfamily using} statements in this page for brevity, but you should do it in your own code.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md515}{}\doxysection{Creating Mock Classes}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md515}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md516}{}\doxysubsection{Mocking Private or Protected Methods}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md516}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md517}{}\doxysubsection{Mocking Overloaded Methods}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md517}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md518}{}\doxysubsection{Mocking Class Templates}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md518}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md519}{}\doxysubsection{Mocking Nonvirtual Methods}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md519}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md520}{}\doxysubsection{Mocking Free Functions}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md520}
...
If you are concerned about the performance overhead incurred by virtual functions, and profiling confirms your concern, you can combine this with the recipe for mocking non-\/virtual methods.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md521}{}\doxysubsection{The Nice, the Strict, and the Naggy}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md521}
...
By defining a new mock method with a trimmed argument list, we make the mock class much more user-\/friendly.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md523}{}\doxysubsection{Alternative to Mocking Concrete Classes}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md523}
...
You need to weigh the pros and cons carefully for your particular problem, but I\textquotesingle{}d like to assure you that the Java community has been practicing this for a long time and it\textquotesingle{}s a proven effective technique applicable in a wide variety of situations. \+:-\/)\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md524}{}\doxysubsection{Delegating Calls to a Fake}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md524}
...
Instead, you can define a {\ttfamily File\+Ops} interface and an {\ttfamily IOOps} interface and split {\ttfamily System}\textquotesingle{}s functionalities into the two. Then you can mock {\ttfamily IOOps} without mocking {\ttfamily File\+Ops}.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md525}{}\doxysubsection{Delegating Calls to a Real Object}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md525}
...
(Why don\textquotesingle{}t we just write {\ttfamily Invoke(\&foo, \&\+Foo\+::\+Concrete)}? If you do that, {\ttfamily Mock\+Foo\+::\+Concrete()} will be called (and cause an infinite recursion) since {\ttfamily Foo\+::\+Concrete()} is virtual. That\textquotesingle{}s just how C++ works.)\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md527}{}\doxysection{Using Matchers}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md527}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md528}{}\doxysubsection{Matching Argument Values Exactly}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md528}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md529}{}\doxysubsection{Using Simple Matchers}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md529}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md530}{}\doxysubsection{Combining Matchers}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md530}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md531}{}\doxysubsection{Casting Matchers}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md531}
...
{\ttfamily Matcher\+Cast} essentially lets you bypass C++\textquotesingle{}s type system ({\ttfamily static\+\_\+cast} isn\textquotesingle{}t always safe as it could throw away information, for example), so be careful not to misuse/abuse it.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md532}{}\doxysubsection{Selecting Between Overloaded Functions}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md532}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md533}{}\doxysubsection{Performing Different Actions Based on the Arguments}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md533}
...
Now, if {\ttfamily foo.\+Do\+This()} is called with a value less than 5, `\textquotesingle{}a'{\ttfamily will be returned; otherwise}\textquotesingle{}b\textquotesingle{}\`{} will be returned.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md534}{}\doxysubsection{Matching Multiple Arguments as a Whole}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md534}
...
Note that if you want to pass the arguments to a predicate of your own (e.\+g. {\ttfamily .With(Args\texorpdfstring{$<$}{<}0, 1\texorpdfstring{$>$}{>}(Truly(\&\+My\+Predicate)))}), that predicate MUST be written to take a {\ttfamily tr1\+::tuple} as its argument; Google \mbox{\hyperlink{class_mock}{Mock}} will pass the {\ttfamily n} selected arguments as {\itshape one} single tuple to the predicate.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md535}{}\doxysubsection{Using Matchers as Predicates}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md535}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md536}{}\doxysubsection{Using Matchers in Google Test Assertions}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md536}
...
{\bfseries{Credit\+:}} The idea of {\ttfamily (ASSERT$\vert$\+EXPECT)\+\_\+\+THAT} was stolen from the \href{http://code.google.com/p/hamcrest/}{\texttt{ Hamcrest}} project, which adds {\ttfamily assert\+That()} to JUnit.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md537}{}\doxysubsection{Using Predicates as Matchers}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md537}
...
Note that the predicate function / functor doesn\textquotesingle{}t have to return {\ttfamily bool}. It works as long as the return value can be used as the condition in statement {\ttfamily if (condition) ...}.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md538}{}\doxysubsection{Matching Arguments that Are Not Copyable}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md538}
...
Remember\+: if you do this, don\textquotesingle{}t change {\ttfamily bar} after the {\ttfamily EXPECT\+\_\+\+CALL()}, or the result is undefined.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md539}{}\doxysubsection{Validating a Member of an Object}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md539}
...
What if you want to validate more than one members at the same time? Remember that there is {\ttfamily All\+Of()}.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md540}{}\doxysubsection{Validating the Value Pointed to by a Pointer Argument}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md540}
...
What if you have a pointer to pointer? You guessed it -\/ you can use nested {\ttfamily Pointee()} to probe deeper inside the value. For example, {\ttfamily Pointee(Pointee(\+Lt(3)))} matches a pointer that points to a pointer that points to a number less than 3 (what a mouthful...).\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md541}{}\doxysubsection{Testing a Certain Property of an Object}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md541}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md542}{}\doxysubsection{Matching Containers}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md542}
...
\end{DoxyItemize}\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md543}{}\doxysubsection{Sharing Matchers}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md543}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md544}{}\doxysection{Setting Expectations}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md544}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md545}{}\doxysubsection{Knowing When to Expect}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md545}
...
Please note that once you expressed interest in a particular mock method (via {\ttfamily EXPECT\+\_\+\+CALL()}), all invocations to it must match some expectation. If this function is called but the arguments don\textquotesingle{}t match any {\ttfamily EXPECT\+\_\+\+CALL()} statement, it will be an error.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md547}{}\doxysubsection{Disallowing Unexpected Calls}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md547}
...
A call to {\ttfamily foo.\+Bar()} that doesn\textquotesingle{}t match any of the {\ttfamily EXPECT\+\_\+\+CALL()} statements will be an error.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md548}{}\doxysubsection{Expecting Ordered Calls}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md548}
...
In this example, we expect a call to {\ttfamily foo.\+Do\+This(5)}, followed by two calls to {\ttfamily bar.\+Do\+That()} where the argument can be anything, which are in turn followed by a call to {\ttfamily foo.\+Do\+This(6)}. If a call occurred out-\/of-\/order, Google \mbox{\hyperlink{class_mock}{Mock}} will report an error.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md549}{}\doxysubsection{Expecting Partially Ordered Calls}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md549}
...
This means that A must occur before B and C, and C must occur before D. There\textquotesingle{}s no restriction about the order other than these.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md550}{}\doxysubsection{Controlling When an Expectation Retires}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md550}
...
Here \#2 can be used only once, so if you have two warnings with the message {\ttfamily \char`\"{}\+File too large.\char`\"{}}, the first will match \#2 and the second will match \#1 -\/ there will be no error.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md551}{}\doxysection{Using Actions}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md551}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md552}{}\doxysubsection{Returning References from Mock Methods}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md552}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md553}{}\doxysubsection{Returning Live Values from Mock Methods}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md553}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md554}{}\doxysubsection{Combining Actions}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md554}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md555}{}\doxysubsection{Mocking Side Effects}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md555}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md556}{}\doxysubsection{Changing a Mock Object\textquotesingle{}s Behavior Based on the State}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md556}
...
Here {\ttfamily my\+\_\+mock.\+Get\+Prev\+Value()} will always return the argument of the last {\ttfamily Update\+Value()} call.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md557}{}\doxysubsection{Setting the Default Value for a Return Type}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md557}
...
Please note that changing the default value for a type can make you tests hard to understand. We recommend you to use this feature judiciously. For example, you may want to make sure the {\ttfamily Set()} and {\ttfamily Clear()} calls are right next to the code that uses your mock.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md558}{}\doxysubsection{Setting the Default Actions for a Mock Method}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md558}
...
The only requirement is that the type of the function, etc must be {\itshape compatible} with the signature of the mock function, meaning that the latter\textquotesingle{}s arguments can be implicitly converted to the corresponding arguments of the former, and the former\textquotesingle{}s return type can be implicitly converted to that of the latter. So, you can invoke something whose type is {\itshape not} exactly the same as the mock function, as long as it\textquotesingle{}s safe to do so -\/ nice, huh?\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md560}{}\doxysubsection{Invoking a Function/\+Method/\+Functor Without Arguments}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md560}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md561}{}\doxysubsection{Invoking an Argument of the Mock Function}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md561}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md562}{}\doxysubsection{Ignoring an Action\textquotesingle{}s Result}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md562}
...
Note that you {\bfseries{cannot}} use {\ttfamily Ignore\+Result()} on an action that already returns {\ttfamily void}. Doing so will lead to ugly compiler errors.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md563}{}\doxysubsection{Selecting an Action\textquotesingle{}s Arguments}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md563}
...
\end{DoxyItemize}\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md564}{}\doxysubsection{Ignoring Arguments in Action Functions}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md564}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md565}{}\doxysubsection{Sharing Actions}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md565}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md566}{}\doxysection{Misc Recipes on Using Google Mock}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md566}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md567}{}\doxysubsection{Making the Compilation Faster}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md567}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md568}{}\doxysubsection{Forcing a Verification}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md568}
...
{\bfseries{Tip\+:}} The {\ttfamily Mock\+::\+Verify\+And\+Clear\+Expectations()} function returns a {\ttfamily bool} to indicate whether the verification was successful ({\ttfamily true} for yes), so you can wrap that function call inside a {\ttfamily ASSERT\+\_\+\+TRUE()} if there is no point going further when the verification has failed.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md569}{}\doxysubsection{Using Check Points}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md569}
...
And that\textquotesingle{}s that.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md571}{}\doxysubsection{Using Google Mock and Threads}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md571}
...
Also, remember that {\ttfamily Default\+Value\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} is a global resource that potentially affects {\itshape all} living mock objects in your program. Naturally, you won\textquotesingle{}t want to mess with it from multiple threads or when there still are mocks in action.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md572}{}\doxysubsection{Controlling How Much Information Google Mock Prints}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md572}
...
Now, judiciously use the right flag to enable Google \mbox{\hyperlink{class_mock}{Mock}} serve you better!\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md573}{}\doxysubsection{Gaining Super Vision into Mock Calls}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md573}
...
Then you can type {\ttfamily M-\/m} to start a build, or {\ttfamily M-\/up}/{\ttfamily M-\/down} to move back and forth between errors.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md575}{}\doxysubsection{Fusing Google Mock Source Files}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md575}
...
\end{DoxyEnumerate}\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md578}{}\doxysubsection{Writing New Parameterized Matchers Quickly}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md578}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md580}{}\doxysubsection{Writing New Polymorphic Matchers}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md580}
...
Like in a monomorphic matcher, you may explain the match result by streaming additional information to the {\ttfamily listener} argument in {\ttfamily Match\+And\+Explain()}.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md581}{}\doxysubsection{Writing New Cardinalities}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md581}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md582}{}\doxysubsection{Writing New Actions Quickly}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md582}
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md583}{}\doxysubsection{Writing New Parameterized Actions Quickly}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md583}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md584}{}\doxysubsection{Restricting the Type of an Argument or Parameter in an ACTION}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md584}
...
\end{DoxyCode}
 where {\ttfamily Static\+Assert\+Type\+Eq} is a compile-\/time assertion in Google Test that verifies two types are the same.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md585}{}\doxysubsection{Writing New Action Templates Quickly}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md585}
...
Are we using a single-\/template-\/parameter action where {\ttfamily bool} refers to the type of {\ttfamily x}, or a two-\/template-\/parameter action where the compiler is asked to infer the type of {\ttfamily x}?\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md586}{}\doxysubsection{Using the ACTION Object\textquotesingle{}s Type}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md586}
...
Note that we have to pick different suffixes ({\ttfamily Action}, {\ttfamily ActionP}, {\ttfamily Action\+P2}, and etc) for actions with different numbers of value parameters, or the action definitions cannot be overloaded on the number of them.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md587}{}\doxysubsection{Writing New Monomorphic Actions}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md587}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md588}{}\doxysubsection{Writing New Polymorphic Actions}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md588}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md589}{}\doxysubsection{Teaching Google Mock How to Print Your Values}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cook_book_autotoc_md589}
