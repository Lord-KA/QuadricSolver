{\bfseries{P}}ump is {\bfseries{U}}seful for {\bfseries{M}}eta {\bfseries{P}}rogramming.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_7__pump_manual_autotoc_md1199}{}\doxysection{The Problem}\label{md_build__deps_googletest_src_googletest_docs__v1_7__pump_manual_autotoc_md1199}
...
\end{DoxyItemize}\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_7__pump_manual_autotoc_md1202}{}\doxysubsection{Examples}\label{md_build__deps_googletest_src_googletest_docs__v1_7__pump_manual_autotoc_md1202}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_7__pump_manual_autotoc_md1203}{}\doxysubsection{Constructs}\label{md_build__deps_googletest_src_googletest_docs__v1_7__pump_manual_autotoc_md1203}
...
{\bfseries{Note\+:}} To give the user some freedom in formatting the Pump source code, Pump ignores a new-\/line character if it\textquotesingle{}s right after {\ttfamily \$for foo} or next to {\ttfamily \mbox{[}\mbox{[}} or {\ttfamily \mbox{]}\mbox{]}}. Without this rule you\textquotesingle{}ll often be forced to write very long lines to get the desired output. Therefore sometimes you may need to insert an extra new-\/line in such places for a new-\/line to show up in your output.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_7__pump_manual_autotoc_md1204}{}\doxysubsection{Grammar}\label{md_build__deps_googletest_src_googletest_docs__v1_7__pump_manual_autotoc_md1204}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_7__pump_manual_autotoc_md1205}{}\doxysubsection{Code}\label{md_build__deps_googletest_src_googletest_docs__v1_7__pump_manual_autotoc_md1205}
You can find the source code of Pump in \href{../scripts/pump.py}{\texttt{ scripts/pump.\+py}}. It is still very unpolished and lacks automated tests, although it has been successfully used many times. If you find a chance to use it in your project, please let us know what you think! We also welcome help on improving Pump.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_7__pump_manual_autotoc_md1206}{}\doxysubsection{Real Examples}\label{md_build__deps_googletest_src_googletest_docs__v1_7__pump_manual_autotoc_md1206}
You can find real-\/world applications of Pump in \href{http://www.google.com/codesearch?q=file\%3A\\.pump\%24+package\%3Ahttp\%3A\%2F\%2Fgoogletest\\.googlecode\\.com}{\texttt{ Google Test}} and \href{http://www.google.com/codesearch?q=file\%3A\\.pump\%24+package\%3Ahttp\%3A\%2F\%2Fgooglemock\\.googlecode\\.com}{\texttt{ Google Mock}}. The source file {\ttfamily foo.\+h.\+pump} generates {\ttfamily foo.\+h}.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_7__pump_manual_autotoc_md1207}{}\doxysubsection{Tips}\label{md_build__deps_googletest_src_googletest_docs__v1_7__pump_manual_autotoc_md1207}
