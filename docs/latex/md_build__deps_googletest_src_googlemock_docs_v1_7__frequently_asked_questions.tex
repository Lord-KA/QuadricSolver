Please send your questions to the \href{http://groups.google.com/group/googlemock}{\texttt{ googlemock}} discussion group. If you need help with compiler errors, make sure you have tried Google Mock Doctor first.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md609}{}\doxysubsection{When I call a method on my mock object, the method for the real object is invoked instead.  What\textquotesingle{}s the problem?}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md609}
In order for a method to be mocked, it must be {\itshape virtual}, unless you use the \href{http://code.google.com/p/googlemock/wiki/V1_7_CookBook\#Mocking_Nonvirtual_Methods}{\texttt{ high-\/perf dependency injection technique}}.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md610}{}\doxysubsection{I wrote some matchers.  After I upgraded to a new version of Google Mock, they no longer compile.  What\textquotesingle{}s going on?}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md610}
...
For more information, you can read these \href{http://code.google.com/p/googlemock/wiki/V1_7_CookBook\#Writing_New_Monomorphic_Matchers}{\texttt{ two}} \href{http://code.google.com/p/googlemock/wiki/V1_7_CookBook\#Writing_New_Polymorphic_Matchers}{\texttt{ recipes}} from the cookbook. As always, you are welcome to post questions on {\ttfamily googlemock@googlegroups.\+com} if you need any help.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md611}{}\doxysubsection{When using Google Mock, do I have to use Google Test as the testing framework?  I have my favorite testing framework and don\textquotesingle{}t want to switch.}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md611}
Google \mbox{\hyperlink{class_mock}{Mock}} works out of the box with Google Test. However, it\textquotesingle{}s easy to configure it to work with any testing framework of your choice. \href{http://code.google.com/p/googlemock/wiki/V1_7_ForDummies\#Using_Google_Mock_with_Any_Testing_Framework}{\texttt{ Here}} is how.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md612}{}\doxysubsection{How am I supposed to make sense of these horrible template errors?}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md612}
...
Or you can run {\ttfamily gmd} and copy-\/n-\/paste gcc\textquotesingle{}s error messages to it.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md613}{}\doxysubsection{Can I mock a variadic function?}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md613}
...
Ellipsis arguments are inherited from C and not really a C++ feature. They are unsafe to use and don\textquotesingle{}t work with arguments that have constructors or destructors. Therefore we recommend to avoid them in C++ as much as possible.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md614}{}\doxysubsection{MSVC gives me warning C4301 or C4373 when I define a mock method with a const parameter.  Why?}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md614}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md615}{}\doxysubsection{I have a huge mock class, and Microsoft Visual C++ runs out of memory when compiling it.  What can I do?}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md615}
We\textquotesingle{}ve noticed that when the {\ttfamily /clr} compiler flag is used, Visual C++ uses 5$\sim$6 times as much memory when compiling a mock class. We suggest to avoid {\ttfamily /clr} when compiling native C++ mocks.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md616}{}\doxysubsection{I can\textquotesingle{}t figure out why Google Mock thinks my expectations are not satisfied.  What should I do?}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md616}
You might want to run your test with {\ttfamily -\/-\/gmock\+\_\+verbose=info}. This flag lets Google \mbox{\hyperlink{class_mock}{Mock}} print a trace of every mock function call it receives. By studying the trace, you\textquotesingle{}ll gain insights on why the expectations you set are not met.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md617}{}\doxysubsection{How can I assert that a function is NEVER called?}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md617}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md618}{}\doxysubsection{I have a failed test where Google Mock tells me TWICE that a particular expectation is not satisfied.  Isn\textquotesingle{}t this redundant?}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md618}
...
By changing {\ttfamily $\sim$\+Base()} to virtual, {\ttfamily $\sim$\+Derived()} will be correctly called when {\ttfamily delete p} is executed, and the heap checker will be happy.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md620}{}\doxysubsection{The \char`\"{}newer expectations override older ones\char`\"{} rule makes writing expectations awkward.  Why does Google Mock do that?}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md620}
...
Also, you can control the verbosity using the {\ttfamily -\/-\/gmock\+\_\+verbose} flag. If you find the output too noisy when debugging, just choose a less verbose level.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md622}{}\doxysubsection{How can I delete the mock function\textquotesingle{}s argument in an action?}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md622}
If you find yourself needing to perform some action that\textquotesingle{}s not supported by Google \mbox{\hyperlink{class_mock}{Mock}} directly, remember that you can define your own actions using \href{http://code.google.com/p/googlemock/wiki/V1_7_CookBook\#Writing_New_Actions}{\texttt{ Make\+Action()}} or \href{http://code.google.com/p/googlemock/wiki/V1_7_CookBook\#Writing_New_Polymorphic_Actions}{\texttt{ Make\+Polymorphic\+Action()}}, or you can write a stub function and invoke it using \href{http://code.google.com/p/googlemock/wiki/V1_7_CookBook\#Using_Functions_Methods_Functors}{\texttt{ Invoke()}}.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md623}{}\doxysubsection{MOCK\+\_\+\+METHODn()\textquotesingle{}s second argument looks funny.  Why don\textquotesingle{}t you use the MOCK\+\_\+\+METHODn(\+Method, return\+\_\+type, arg\+\_\+1, ..., arg\+\_\+n) syntax?}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md623}
...
\end{DoxyEnumerate}\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md624}{}\doxysubsection{My code calls a static/global function.  Can I mock it?}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md624}
...
This Google Testing Blog \href{http://googletesting.blogspot.com/2008/06/defeat-static-cling.html}{\texttt{ post}} says it excellently. Check it out.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md625}{}\doxysubsection{My mock object needs to do complex stuff.  It\textquotesingle{}s a lot of pain to specify the actions.  Google Mock sucks!}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md625}
...
See this \href{http://code.google.com/p/googlemock/wiki/V1_7_CookBook\#Mocking_Side_Effects}{\texttt{ recipe}} for more details and an example.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md629}{}\doxysubsection{My question is not in your FAQ!}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__frequently_asked_questions_autotoc_md629}
