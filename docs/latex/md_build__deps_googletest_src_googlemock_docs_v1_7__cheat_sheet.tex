\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md480}{}\doxysection{Mocking a Normal Class}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md480}
Given 
\begin{DoxyCode}{0}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md481}{}\doxysection{Mocking a Class Template}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md481}
To mock 
\begin{DoxyCode}{0}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md482}{}\doxysection{Specifying Calling Conventions for Mock Functions}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md482}
...
\end{DoxyCode}
 where {\ttfamily STDMETHODCALLTYPE} is defined by {\ttfamily \texorpdfstring{$<$}{<}objbase.\+h\texorpdfstring{$>$}{>}} on Windows.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md483}{}\doxysection{Using Mocks in Tests}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md483}
The typical flow is\+:
\begin{DoxyEnumerate}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md484}{}\doxysection{Setting Default Actions}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md484}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md485}{}\doxysection{Setting Expectations}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md485}
...
A method with no {\ttfamily EXPECT\+\_\+\+CALL()} is free to be invoked {\itshape any number of times}, and the default action will be taken each time.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md486}{}\doxysection{Matchers}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md486}
...
Built-\/in matchers (where {\ttfamily argument} is the function argument) are divided into several categories\+:\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md487}{}\doxysubsection{Wildcard}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md487}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md488}{}\doxysubsection{Generic Comparison}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md488}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md490}{}\doxysubsection{String Matchers}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md490}
...
{\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} use the regular expression syntax defined \href{http://code.google.com/p/googletest/wiki/AdvancedGuide\#Regular_Expression_Syntax}{\texttt{ here}}. {\ttfamily Str\+Case\+Eq()}, {\ttfamily Str\+Case\+Ne()}, {\ttfamily Str\+Eq()}, and {\ttfamily Str\+Ne()} work for wide strings as well.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md491}{}\doxysubsection{Container Matchers}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md491}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md492}{}\doxysubsection{Member Matchers}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md492}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md493}{}\doxysubsection{Matching the Result of a Function or Functor}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md493}
$\vert${\ttfamily Result\+Of(f, m)}$\vert${\ttfamily f(argument)} matches matcher {\ttfamily m}, where {\ttfamily f} is a function or functor.$\vert$ $\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md494}{}\doxysubsection{Pointer Matchers}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md494}
$\vert${\ttfamily Pointee(m)}$\vert${\ttfamily argument} (either a smart pointer or a raw pointer) points to a value that matches matcher {\ttfamily m}.$\vert$ $\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md495}{}\doxysubsection{Multiargument Matchers}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md495}
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md496}{}\doxysubsection{Composite Matchers}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md496}
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md497}{}\doxysubsection{Adapters for Matchers}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md497}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md498}{}\doxysubsection{Matchers as Predicates}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md498}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md499}{}\doxysubsection{Defining Matchers}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md499}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{DoxyEnumerate}\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md500}{}\doxysubsection{Matchers as Test Assertions}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md500}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md501}{}\doxysection{Actions}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md501}
{\bfseries{Actions}} specify what a mock function should do when invoked.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md502}{}\doxysubsection{Returning a Value}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md502}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md503}{}\doxysubsection{Side Effects}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md503}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md504}{}\doxysubsection{Using a Function or a Functor as an Action}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md504}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{DoxyCode}
 calls the mock function\textquotesingle{}s \#2 argument, passing to it {\ttfamily 5} and {\ttfamily string(\char`\"{}\+Hi\char`\"{})} by value, and {\ttfamily foo} by reference.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md505}{}\doxysubsection{Default Action}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md505}
...
{\bfseries{Note\+:}} due to technical reasons, {\ttfamily Do\+Default()} cannot be used inside a composite action -\/ trying to do so will result in a run-\/time error.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md506}{}\doxysubsection{Composite Actions}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md506}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md507}{}\doxysubsection{Defining Actions}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md507}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
The {\ttfamily ACTION$\ast$} macros cannot be used inside a function or class.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md508}{}\doxysection{Cardinalities}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md508}
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md509}{}\doxysection{Expectation Order}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md509}
By default, the expectations can be matched in {\itshape any} order. If some or all expectations must be matched in a given order, there are two ways to specify it. They can be used either independently or together.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md510}{}\doxysubsection{The After Clause}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md510}
...
Modifying an {\ttfamily Expectation\+Set} after using it in an {\ttfamily .After()} doesn\textquotesingle{}t affect the meaning of the {\ttfamily .After()}.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md511}{}\doxysubsection{Sequences}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md511}
...
\end{DoxyCode}
 says that all expected calls in the scope of {\ttfamily dummy} must occur in strict order. The name {\ttfamily dummy} is irrelevant.)\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md512}{}\doxysection{Verifying and Resetting a Mock}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md512}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md513}{}\doxysection{Mock Classes}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md513}
...
\end{DoxyCode}
 See this \href{http://code.google.com/p/googlemock/wiki/V1_7_CookBook\#Using_Check_Points}{\texttt{ recipe}} for one application of it.\hypertarget{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md514}{}\doxysection{Flags}\label{md_build__deps_googletest_src_googlemock_docs_v1_7__cheat_sheet_autotoc_md514}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
