...
\DoxyCodeLine{52 \textcolor{keyword}{class }\mbox{\hyperlink{classtesting_1_1internal_1_1_invoke_action}{InvokeAction}} \{}
...
\DoxyCodeLine{56   \textcolor{keyword}{explicit} \mbox{\hyperlink{classtesting_1_1internal_1_1_invoke_action}{InvokeAction}}(FunctionImpl function\_impl)}
...
\DoxyCodeLine{61     \textcolor{keywordflow}{return} \mbox{\hyperlink{classtesting_1_1internal_1_1_invoke_helper}{InvokeHelper<Result, ArgumentTuple>::Invoke}}(function\_impl\_, args);}
\DoxyCodeLine{62   \}}
\DoxyCodeLine{63 }
\DoxyCodeLine{64  \textcolor{keyword}{private}:}
\DoxyCodeLine{65   FunctionImpl function\_impl\_;}
\DoxyCodeLine{66 }
\DoxyCodeLine{67   GTEST\_DISALLOW\_ASSIGN\_(\mbox{\hyperlink{classtesting_1_1internal_1_1_invoke_action}{InvokeAction}});}
\DoxyCodeLine{68 \};}
\DoxyCodeLine{69 }
...
\DoxyCodeLine{72 \textcolor{keyword}{class }\mbox{\hyperlink{classtesting_1_1internal_1_1_invoke_method_action}{InvokeMethodAction}} \{}
\DoxyCodeLine{73  \textcolor{keyword}{public}:}
\DoxyCodeLine{74   \mbox{\hyperlink{classtesting_1_1internal_1_1_invoke_method_action}{InvokeMethodAction}}(Class* obj\_ptr, MethodPtr method\_ptr)}
...
\DoxyCodeLine{79     \textcolor{keywordflow}{return} \mbox{\hyperlink{classtesting_1_1internal_1_1_invoke_helper}{InvokeHelper<Result, ArgumentTuple>::InvokeMethod}}(}
...
\DoxyCodeLine{89 }
\DoxyCodeLine{90   GTEST\_DISALLOW\_ASSIGN\_(\mbox{\hyperlink{classtesting_1_1internal_1_1_invoke_method_action}{InvokeMethodAction}});}
\DoxyCodeLine{91 \};}
\DoxyCodeLine{92 }
