({\bfseries{Note\+:}} If you get compiler errors that you don\textquotesingle{}t understand, be sure to consult Google Mock Doctor.)\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md291}{}\doxysection{What Is Google C++ Mocking Framework?}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md291}
...
\end{DoxyEnumerate}\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md292}{}\doxysection{Why Google Mock?}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md292}
...
\end{DoxyItemize}\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md293}{}\doxysection{Getting Started}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md293}
Using Google \mbox{\hyperlink{class_mock}{Mock}} is easy! Inside your C++ source file, just {\ttfamily \#include} {\ttfamily \texorpdfstring{$<$}{<}\mbox{\hyperlink{gtest_8h_source}{gtest/gtest.\+h}}\texorpdfstring{$>$}{>}} and {\ttfamily \texorpdfstring{$<$}{<}\mbox{\hyperlink{gmock_8h_source}{gmock/gmock.\+h}}\texorpdfstring{$>$}{>}}, and you are ready to go.\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md294}{}\doxysection{A Case for Mock Turtles}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md294}
...
Your program will normally use a real implementation of this interface. In tests, you can use a mock implementation instead. This allows you to easily check what drawing primitives your program is calling, with what arguments, and in which order. Tests written this way are much more robust (they won\textquotesingle{}t break because your new machine does anti-\/aliasing differently), easier to read and maintain (the intent of a test is expressed in the code, not in some binary images), and run {\itshape much, much faster}.\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md295}{}\doxysection{Writing the Mock Class}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md295}
If you are lucky, the mocks you need to use have already been implemented by some nice people. If, however, you find yourself in the position to write a mock class, relax -\/ Google \mbox{\hyperlink{class_mock}{Mock}} turns this task into a fun game! (Well, almost.)\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md296}{}\doxysubsection{How to Define It}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md296}
...
Admittedly, this test is contrived and doesn\textquotesingle{}t do much. You can easily achieve the same effect without using Google \mbox{\hyperlink{class_mock}{Mock}}. However, as we shall reveal soon, Google \mbox{\hyperlink{class_mock}{Mock}} allows you to do {\itshape much more} with the mocks.\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md299}{}\doxysubsection{Using Google Mock with Any Testing Framework}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md299}
...
If this turns out to be too much work, we suggest that you stick with Google Test, which works with Google \mbox{\hyperlink{class_mock}{Mock}} seamlessly (in fact, it is technically part of Google \mbox{\hyperlink{class_mock}{Mock}}.). If there is a reason that you cannot use Google Test, please let us know.\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md300}{}\doxysection{Setting Expectations}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md300}
The key to using a mock object successfully is to set the {\itshape right expectations} on it. If you set the expectations too strict, your test will fail as the result of unrelated changes. If you set them too loose, bugs can slip through. You want to do it just right such that your test can catch exactly the kind of bugs you intend it to catch. Google \mbox{\hyperlink{class_mock}{Mock}} provides the necessary means for you to do it \char`\"{}just right.\char`\"{}\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md301}{}\doxysubsection{General Syntax}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md301}
...
{\bfseries{Note\+:}} Why do we use a macro to do this? It serves two purposes\+: first it makes expectations easily identifiable (either by {\ttfamily grep} or by a human reader), and second it allows Google \mbox{\hyperlink{class_mock}{Mock}} to include the source file location of a failed expectation in messages, making debugging easier.\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md302}{}\doxysubsection{Matchers\+: What Arguments Do We Expect?}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md302}
...
This checks that the turtle will be told to go forward by at least 100 units.\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md303}{}\doxysubsection{Cardinalities\+: How Many Times Will It Be Called?}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md303}
...
Obviously {\ttfamily turtle.\+Get\+Y()} is expected to be called four times. But if you think it will return 100 every time, think twice! Remember that one {\ttfamily Will\+Once()} clause will be consumed each time the function is invoked and the default action will be taken afterwards. So the right answer is that {\ttfamily turtle.\+Get\+Y()} will return 100 the first time, but {\bfseries{return 0 from the second time on}}, as returning 0 is the default action for {\ttfamily int} functions.\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md305}{}\doxysubsection{Using Multiple Expectations}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md305}
...
(What if you care about the relative order of some of the calls, but not all of them? Can you specify an arbitrary partial order? The answer is ... yes! If you are impatient, the details can be found in the Cook\+Book.)\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md307}{}\doxysubsection{All Expectations Are Sticky (\+Unless Said Otherwise)}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md307}
...
By the way, the other situation where an expectation may {\itshape not} be sticky is when it\textquotesingle{}s in a sequence -\/ as soon as another expectation that comes after it in the sequence has been used, it automatically retires (and will never be used to match any call).\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md308}{}\doxysubsection{Uninteresting Calls}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md308}
...
In Google \mbox{\hyperlink{class_mock}{Mock}}, if you are not interested in a method, just don\textquotesingle{}t say anything about it. If a call to this method occurs, you\textquotesingle{}ll see a warning in the test output, but it won\textquotesingle{}t be a failure.\hypertarget{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md309}{}\doxysection{What Now?}\label{md__home_user__documents__m_i_p_t_quadric_solver_build__deps_googletest_src_googlemock_docs_v1_5__for_dummies_autotoc_md309}
