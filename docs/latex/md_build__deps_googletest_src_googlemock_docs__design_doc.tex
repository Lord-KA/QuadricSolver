This page discusses the design of new Google \mbox{\hyperlink{class_mock}{Mock}} features.\hypertarget{md_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md113}{}\doxysection{Macros for Defining Actions}\label{md_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md113}
\hypertarget{md_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md114}{}\doxysubsection{Problem}\label{md_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md114}
...
Our goal is to allow defining custom actions with the least amount of boiler-\/plate C++ requires.\hypertarget{md_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md115}{}\doxysubsection{Solution}\label{md_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md115}
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md116}{}\doxysubsection{Parameterized actions}\label{md_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md116}
...
You can view {\ttfamily ACTION} as a degenerated parameterized action where the number of parameters is 0.\hypertarget{md_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md117}{}\doxysubsection{Advanced Usages}\label{md_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md117}
\hypertarget{md_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md118}{}\doxysubsubsection{Overloading Actions}\label{md_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md118}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md119}{}\doxysubsubsection{Restricting the Type of an Argument or Parameter}\label{md_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md119}
...
\end{DoxyCode}
 where {\ttfamily Static\+Assert\+Type\+Eq} is a compile-\/time assertion we plan to add to Google Test (the name is chosen to match {\ttfamily static\+\_\+assert} in C++0x).\hypertarget{md_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md120}{}\doxysubsubsection{Using the ACTION Object\textquotesingle{}s Type}\label{md_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md120}
...
{\ttfamily ACTION$\ast$} avoid all these problems.\hypertarget{md_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md123}{}\doxysubsection{Future Improvements}\label{md_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md123}
...
C++0x will also support lambda expressions. When they become available, we may want to support using lambdas as actions.\hypertarget{md_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md124}{}\doxysection{Macros for Defining Matchers}\label{md_build__deps_googletest_src_googlemock_docs__design_doc_autotoc_md124}
