Now that you have read \mbox{\hyperlink{md_build__deps_googletest_src_googletest_docs__v1_6__primer}{Primer}} and learned how to write tests using Google Test, it\textquotesingle{}s time to learn some new tricks. This document will show you more assertions as well as how to construct complex failure messages, propagate fatal failures, reuse and speed up your test fixtures, and use various flags with your tests.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md935}{}\doxysection{More Assertions}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md935}
This section covers some less frequently used, but still significant, assertions.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md936}{}\doxysubsection{Explicit Success and Failure}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md936}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md937}{}\doxysubsection{Exception Assertions}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md937}
...
{\itshape Availability}\+: Linux, Windows, Mac; since version 1.\+1.\+0.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md938}{}\doxysubsection{Predicate Assertions for Better Error Messages}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md938}
...
Google Test gives you three different options to solve this problem\+:\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md939}{}\doxysubsubsection{Using an Existing Boolean Function}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md939}
...
{\itshape Availability}\+: Linux, Windows, Mac\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md940}{}\doxysubsubsection{Using a Function That Returns an Assertion\+Result}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md940}
...
{\itshape Availability}\+: Linux, Windows, Mac; since version 1.\+4.\+1.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md941}{}\doxysubsubsection{Using a Predicate-\/\+Formatter}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md941}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md942}{}\doxysubsection{Floating-\/\+Point Comparison}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md942}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md944}{}\doxysubsubsection{Floating-\/\+Point Predicate-\/\+Format Functions}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md944}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md945}{}\doxysubsection{Windows HRESULT assertions}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md945}
...
{\itshape Availability}\+: Windows.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md946}{}\doxysubsection{Type Assertions}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md946}
...
{\itshape Availability\+:} Linux, Windows, Mac; since version 1.\+3.\+0.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md947}{}\doxysubsection{Assertion Placement}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md947}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md949}{}\doxysection{Death Tests}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md949}
...
If you want to test {\ttfamily EXPECT\+\_\+$\ast$()/\+ASSERT\+\_\+$\ast$()} failures in your test code, see \href{\#catching-failures}{\texttt{ Catching Failures}}.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md950}{}\doxysubsection{How to Write a Death Test}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md950}
...
{\itshape Availability\+:} Linux, Windows (requires MSVC 8.\+0 or above), Cygwin, and Mac (the latter three are supported since v1.\+3.\+0). {\ttfamily (ASSERT$\vert$\+EXPECT)\+\_\+\+DEATH\+\_\+\+IF\+\_\+\+SUPPORTED} are new in v1.\+4.\+0.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md951}{}\doxysubsection{Regular Expression Syntax}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md951}
...
If the death test statement runs to completion without dying, the child process will nonetheless terminate, and the assertion fails.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md953}{}\doxysubsection{Death Tests And Threads}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md953}
...
It\textquotesingle{}s perfectly fine to create threads inside a death test statement; they are executed in a separate process and cannot affect the parent.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md954}{}\doxysubsection{Death Test Styles}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md954}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md955}{}\doxysubsection{Caveats}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md955}
...
Despite the improved thread safety afforded by the \char`\"{}threadsafe\char`\"{} style of death test, thread problems such as deadlock are still possible in the presence of handlers registered with {\ttfamily pthread\+\_\+atfork(3)}.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md956}{}\doxysection{Using Assertions in Sub-\/routines}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md956}
\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md957}{}\doxysubsection{Adding Traces to Assertions}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md957}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md958}{}\doxysubsection{Propagating Fatal Failures}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md958}
...
{\itshape Availability\+:} Linux, Windows, Mac. Assertions from multiple threads are currently not supported.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md960}{}\doxysubsubsection{Checking for Failures in the Current Test}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md960}
...
{\itshape Availability\+:} Linux, Windows, Mac. {\ttfamily Has\+Nonfatal\+Failure()} and {\ttfamily Has\+Failure()} are available since version 1.\+4.\+0.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md961}{}\doxysection{Logging Additional Information}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md961}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md962}{}\doxysection{Sharing Resources Between Tests in the Same Test Case}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md962}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md963}{}\doxysection{Global Set-\/\+Up and Tear-\/\+Down}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md963}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md964}{}\doxysection{Value Parameterized Tests}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md964}
...
\end{DoxyItemize}\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md965}{}\doxysubsection{How to Write Value-\/\+Parameterized Tests}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md965}
...
{\itshape Availability}\+: Linux, Windows (requires MSVC 8.\+0 or above), Mac; since version 1.\+2.\+0.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md966}{}\doxysubsection{Creating Value-\/\+Parameterized Abstract Tests}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md966}
...
Once they are defined, you can instantiate them by including {\ttfamily foo\+\_\+param\+\_\+test.\+h}, invoking {\ttfamily INSTANTIATE\+\_\+\+TEST\+\_\+\+CASE\+\_\+\+P()}, and linking with {\ttfamily foo\+\_\+param\+\_\+test.\+cc}. You can instantiate the same abstract test case multiple times, possibly in different source files.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md967}{}\doxysection{Typed Tests}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md967}
...
{\itshape Availability\+:} Linux, Windows (requires MSVC 8.\+0 or above), Mac; since version 1.\+1.\+0.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md968}{}\doxysection{Type-\/\+Parameterized Tests}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md968}
...
{\itshape Availability\+:} Linux, Windows (requires MSVC 8.\+0 or above), Mac; since version 1.\+1.\+0.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md969}{}\doxysection{Testing Private Code}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md969}
...
\end{DoxyItemize}\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md970}{}\doxysubsection{Static Functions}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md970}
...
However, a better approach is to move the private code into the {\ttfamily foo\+::internal} namespace, where {\ttfamily foo} is the namespace your project normally uses, and put the private declarations in a {\ttfamily $\ast$-\/internal.h} file. Your production {\ttfamily .cc} files and your tests are allowed to include this internal header, but your clients are not. This way, you can fully test your internal implementation without leaking it to your clients.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md971}{}\doxysubsection{Private Class Members}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md971}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md972}{}\doxysection{Catching Failures}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md972}
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md973}{}\doxysection{Getting the Current Test\textquotesingle{}s Name}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md973}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md974}{}\doxysection{Extending Google Test by Handling Test Events}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md974}
...
{\itshape Availability\+:} Linux, Windows, Mac; since v1.\+4.\+0.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md975}{}\doxysubsection{Defining Event Listeners}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md975}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md976}{}\doxysubsection{Using Event Listeners}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md976}
...
You may append more than one listener to the list. When an {\ttfamily On$\ast$\+Start()} or {\ttfamily On\+Test\+Part\+Result()} event is fired, the listeners will receive it in the order they appear in the list (since new listeners are added to the end of the list, the default text printer and the default XML generator will receive the event first). An {\ttfamily On$\ast$\+End()} event will be received by the listeners in the {\itshape reverse} order. This allows output by listeners added later to be framed by output from listeners added earlier.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md977}{}\doxysubsection{Generating Failures in Listeners}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md977}
...
We have a sample of failure-\/raising listener \href{../samples/sample10_unittest.cc}{\texttt{ here}}.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md978}{}\doxysection{Running Test Programs\+: Advanced Options}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md978}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md979}{}\doxysubsection{Selecting Tests}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md979}
This section shows various options for choosing which tests to run.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md980}{}\doxysubsubsection{Listing Test Names}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md980}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md981}{}\doxysubsubsection{Running a Subset of the Tests}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md981}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md982}{}\doxysubsubsection{Temporarily Disabling Tests}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md982}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md983}{}\doxysubsubsection{Temporarily Enabling Disabled Tests}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md983}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md984}{}\doxysubsection{Repeating the Tests}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md984}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md985}{}\doxysubsection{Shuffling the Tests}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md985}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md986}{}\doxysubsection{Controlling Test Output}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md986}
{\itshape  This section teaches how to tweak the way test results are reported.}

{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md987}{}\doxysubsubsection{Colored Terminal Output}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md987}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md988}{}\doxysubsubsection{Suppressing the Elapsed Time}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md988}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md989}{}\doxysubsubsection{Generating an XML Report}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md989}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md990}{}\doxysubsection{Controlling How Failures Are Reported}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md990}
{\itshape  }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md991}{}\doxysubsubsection{Turning Assertion Failures into Break-\/\+Points}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md991}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md992}{}\doxysubsubsection{Disabling Catching Test-\/\+Thrown Exceptions}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md992}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md993}{}\doxysubsubsection{Letting Another Testing Framework Drive}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md993}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md994}{}\doxysubsection{Distributing Test Functions to Multiple Machines}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md994}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md995}{}\doxysection{Fusing Google Test Source Files}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md995}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md996}{}\doxysection{Where to Go from Here}\label{md_build__deps_googletest_src_googletest_docs__v1_6__advanced_guide_autotoc_md996}
{\itshape  Congratulations! You\textquotesingle{}ve now learned more advanced Google Test tools and are ready to tackle more complex testing tasks. If you want to dive even deeper, you can read the \mbox{\hyperlink{md_build__deps_googletest_src_googletest_docs__v1_6__f_a_q}{Frequently-\/\+Asked Questions}}. }